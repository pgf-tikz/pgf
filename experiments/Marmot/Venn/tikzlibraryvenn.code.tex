...
\tikzset{reverse clip/.style={insert path={{% https://tex.stackexchange.com/a/127045
...
\tikzset{Venn diagram/.style={/utils/exec=\tikzset{venn/.cd,#1},
 ...
 {\pgfmathsetmacro{\mylabel}{{\pgfkeysvalueof{/tikz/venn/labels}}[\Num]}
  \draw[/tikz/venn/lines,/tikz/venn/circle \mylabel/.try] ({240-30*\pgfkeysvalueof{/tikz/venn/number of sets}+
  360*\Num/\pgfkeysvalueof{/tikz/venn/number of
  sets}}:\pgfkeysvalueof{/tikz/venn/distance}) 
  coordinate[label={[anchor=center]:$\mylabel$}](c\mylabel) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}];}
 \end{scope}
 \pgf@venn@codes
...
radius/.initial=1.2cm,labels/.initial={"A","B","C"},frame/.style={thick},
...
\tikzset{venn/.cd,
 % one set
 \pgfutil@tmpA/.code={%
  \path[venn/pstyle,##1] (c\pgfutil@tmpA) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}]; },
 \pgfutil@tmpB/.code={%
  \path[venn/pstyle,##1] (c\pgfutil@tmpB) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}]; },
 \pgfutil@tmpC/.code={%
  \path[venn/pstyle,##1] (c\pgfutil@tmpC) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}]; },
 % intersections
 ...
 % one set
 -\pgfutil@tmpA/.code={%
  \path[clip] (c\pgfutil@tmpA) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}] [reverse clip']; },
 -\pgfutil@tmpB/.code={%
  \path[clip] (c\pgfutil@tmpB) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}] [reverse clip']; },
 -\pgfutil@tmpC/.code={%
  \path[clip] (c\pgfutil@tmpC) circle[radius=\pgfkeysvalueof{/tikz/venn/radius}] [reverse clip'];
},
 % intersections
 -\pgfutil@tmpA n\pgfutil@tmpB/.code={%
  \path[clip,venn/and={{\pgfutil@tmpA} and \pgfutil@tmpB}] [reverse clip]; },
 -\pgfutil@tmpA n\pgfutil@tmpC/.code={%
  \path[clip,venn/and={{\pgfutil@tmpA} and \pgfutil@tmpC}] [reverse clip]; },
 -\pgfutil@tmpB n\pgfutil@tmpA/.code={%
  \path[clip,venn/and={{\pgfutil@tmpB} and \pgfutil@tmpA}] [reverse clip]; },
 -\pgfutil@tmpB n\pgfutil@tmpC/.code={%
  \path[clip,venn/and={{\pgfutil@tmpB} and \pgfutil@tmpC}] [reverse clip]; },
 -\pgfutil@tmpC n\pgfutil@tmpA/.code={%
  \path[clip,venn/and={{\pgfutil@tmpC} and \pgfutil@tmpA}] [reverse clip]; },
 -\pgfutil@tmpC n\pgfutil@tmpB/.code={%
  \path[clip,venn/and={{\pgfutil@tmpC} and \pgfutil@tmpB}] [reverse clip]; },
 % unions 
 -\pgfutil@tmpA u\pgfutil@tmpB/.code={%
  \path[clip,venn/union={{\pgfutil@tmpA} and \pgfutil@tmpB}] [reverse clip]; },
 -\pgfutil@tmpA u\pgfutil@tmpC/.code={%
  \path[clip,venn/union={{\pgfutil@tmpA} and \pgfutil@tmpC}] [reverse clip]; },
 -\pgfutil@tmpB u\pgfutil@tmpA/.code={%
  \path[clip,venn/union={{\pgfutil@tmpB} and \pgfutil@tmpA}] [reverse clip]; },
 -\pgfutil@tmpB u\pgfutil@tmpC/.code={%
  \path[clip,venn/union={{\pgfutil@tmpB} and \pgfutil@tmpC}] [reverse clip]; },
 -\pgfutil@tmpC u\pgfutil@tmpA/.code={%
  \path[clip,venn/union={{\pgfutil@tmpC} and \pgfutil@tmpA}] [reverse clip]; },
 -\pgfutil@tmpC u\pgfutil@tmpB/.code={%
  \path[clip,venn/union={{\pgfutil@tmpC} and \pgfutil@tmpB}] [reverse clip]; },  }  
}
\endinput
