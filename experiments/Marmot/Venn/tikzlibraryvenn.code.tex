...
% Big thanks go to JouleV for feedback and suggestions
...
\tikzset{Venn diagram/.style={/utils/exec=\tikzset{venn/.cd,#1},
 ...
 {\pgfmathsetmacro{\mylabel}{{\pgfkeysvalueof{/tikz/venn/labels}}[\Num]}
  ...
  sets}}:\pgfkeysvalueof{/tikz/venn/distance}) coordinate[label={[anchor=center]:$\mylabel$}]
