...
{abs,acos,add,and,array,asin,atan,atan2,bin,ceil,cos,
 ...
 floor,frac,gcd,greater,height,hex,Hex,hypot,int,ifthenelse,iseven,isodd,isprime,
...
\begin{math-function}{hypot(\mvar{x},\mvar{y})}
\mathcommand
    Calculates $\sqrt{\textrm{\mvar{x}}^2 + \textrm{\mvar{y}}^2}$ without
    overflow in intermediate results.
    %
\begin{codeexample}[]
\pgfmathparse{hypot(3,4)} \pgfmathresult
\end{codeexample}
    %
\end{math-function}
