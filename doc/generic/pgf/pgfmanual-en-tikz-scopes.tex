...
\begin{environment}{{tikzpicture}\opt{\meta{animations spec}}\opt{\oarg{options}}}
    ...
    \begin{key}{/tikz/baseline=\meta{dimension or coordinate or \texttt{default}} (default 0pt)}
        ...
        |\tikz\draw(0,0)circle[radius=.5ex];|, \pgfname\ will find out that the lower
        ...
        baseline, resulting in the following: \tikz\draw(0,0)circle[radius=.5ex];.
        ...
        For example, |\tikz[baseline=0pt]\draw(0,0)circle[radius=.5ex];| yields
        \tikz[baseline=0pt]\draw(0,0)circle[radius=.5ex]; since, now, the baseline is
