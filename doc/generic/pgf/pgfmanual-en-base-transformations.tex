...
\end{codeexample}
    ...
    |\ifpgfallowupsidedownattime|. If this is false, \pgfname\ will ensure that
...
\begin{command}{\pgftransformcurveattime\marg{time}\marg{start}\marg{first support}\marg{second support}\marg{end}}
    ...
    of |\ifpgfallowupsidedownattime| is also considered.
    %
\begin{codeexample}[]
\begin{tikzpicture}
  \draw[help lines] (0,0) grid (3,2);
...
\begin{command}{\pgftransformarcaxesattime\marg{time
    ...
    additional rotation should be applied and |\ifpgfallowupsidedownattime| is
    also considered.
    %
\begin{codeexample}[]
\begin{tikzpicture}
...
{
    \let\ifpgfallowupsidedownattime=\relax
    \begin{textoken}{\ifpgfallowupsidedownattime}
