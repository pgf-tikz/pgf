...
\begin{tikzpicture}
  \foreach \a in {3,...,7}{
    \draw[red, dashed] (\a*2,0)  circle[radius=0.5cm];
...
\begin{tikzpicture}
  \foreach \a in {3,...,7}{
    \draw[blue, dashed] (\a*2,0)  circle[radius=0.5cm];
...
\begin{tikzpicture}
   ...
   \draw [blue, dashed]  (1,1) circle[radius=1cm];
   \draw [red, dashed] (1,1) circle[radius=.5cm];
