...
you have to say \meta{symbol name}| graphic=var| \meta{symbol name}
|IEC graphic|.
\medskip
...
\begin{codeexample}[]
\begin{tikzpicture}[circuit ee IEC]
  \draw (0,3) to[diode          = light emitting]  (3,3);
  \draw (0,2) to[diode          = light dependent] (3,2);
  \draw (0,1) to[resistor       = light dependent] (3,1);
