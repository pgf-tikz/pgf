...
\begin{command}{\pgftransformapproximatenonlineartransformation}
...
\begin{command}{\pgftransformapproximatenonlineartranslation}
...
\begin{tikzpicture}
  ...
  \begin{scope}[shift={(45pt,20mm)}]
    ...
    % Now draw the same, but in the "approximate" coordinate system:
    \pgftransformapproximatenonlineartranslation
    \draw [] (-10pt,-10pt) -- (10pt,10pt);    
    \draw [] (10pt,-10pt) -- (-10pt,10pt);
    \pgftext{foo};
  \end{scope}
