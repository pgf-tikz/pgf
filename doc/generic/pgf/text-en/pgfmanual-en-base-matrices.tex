...
\end{codeexample}
    ...
    The matrix node is never rotated or shifted, because the current coordinate
    ...
    future. If you need to rotate the matrix, you must install an appropriate
    canvas transformation yourself.
