...
\begin{arrowtip}{Bracket}{
    This is an instance of the |Tee Barb| \tdososp{no space shown here} arrow tip that results in something
...
\begin{arrowtip}{Parenthesis}{
    This arrow tip is an instantiation of the |Arc Barb| \tdososp{no space shown here} so that it resembles a
