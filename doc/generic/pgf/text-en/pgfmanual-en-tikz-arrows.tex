...
\end{codeexample}
%
\begin{codeexample}[preamble={\usetikzlibrary{bending,positioning}}]
\tikz {
  \node [circle,draw] (A)              {A};
...
% ---
% TODOsp: These examples don't need the `arrows.meta` library
\begin{codeexample}[]
...
\end{codeexample}
    %
\end{key}
% TODOsp: `bending` library is needed up to here
% TODOsp: `\def\wall` + `patterns` library are needed up to here
% TODOsp: `arrows.meta` library needed up to here
