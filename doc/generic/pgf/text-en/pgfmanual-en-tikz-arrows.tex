...
In addition to the above, the library makes one special definition:
...
\begin{codeexample}[]
\tikz \graph [simple necklace layout, node distance=1.5cm, math nodes,
...
\begin{arrowtip}{Rays}
  ...
  \end{arrowexamples}
\end{arrowtip}
\begin{key}{/pgf/arrow key/n=\meta{number} (initially 4)}
