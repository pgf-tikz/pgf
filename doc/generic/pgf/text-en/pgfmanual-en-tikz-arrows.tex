...
%
% (to avoid showing >> as » zero-width spaces were added between the > signs)
\begin{itemize}
...
start or end of the line: \todosp{how to avoid double < or > signs to be
displayed as guillemets (see bug \#473)}
%
\begin{codeexample}[]
\tikz \draw [<<<->>>>] (0,0) -- (2,0);
\end{codeexample}
%
The question now is: What will the distance be between them? For this, the
