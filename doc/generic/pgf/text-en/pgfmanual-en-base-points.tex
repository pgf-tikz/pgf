...
\subsubsection{Points on the Intersection of Curves}

\begin{command}{\pgfpointintersectionofcurves{\marg{$p_1$}}{\marg{$p_2$}}{\marg{$p_3$}}{\marg{$p_4$}}{\marg{$q_1$}}{\marg{$q_2$}}{\marg{$q_3$}}{\marg{$q_4$}}{\marg{solutions}}}

  This command returns the intersection of two bezier curves $P$ and 
  $Q$, where $P$ is described by the points $p_1$, $p_2$, $p_3$ and 
  $p_4$, and $Q$ is described by the points $q_1$, $q_2$, $q_3$ and 
  $q_4$. If \meta{solution} is greater than the number of 
  intersections calculated, the origin is returned.

\begin{codeexample}[]
\begin{tikzpicture}
  \draw [help lines] grid (2,2);
  \draw (0,2) .. controls (0,-1) and (2,-1) .. (2,2);
  \draw (-1,1) .. controls (0,1) and (2,1) .. (2,-1);
  \pgfpathcircle{
    \pgfpointintersectionofcurves
      {\pgfpointxy{0}{2}}{\pgfpointxy{0}{-1}}
      {\pgfpointxy{2}{-1}}{\pgfpointxy{2}{2}}
      {\pgfpointxy{-1}{1}}{\pgfpointxy{0}{1}}
      {\pgfpointxy{2}{1}}{\pgfpointxy{2}{-1}}
      {2}
  }{2pt}
  \pgfusepath{stroke}
\end{tikzpicture}
...
\subsubsection{Points on the Intersection of a Line and a Curve}

\begin{command}{\pgfpointintersectionoflineandcurve{\marg{$l_1$}}{\marg{$l_2$}}{\marg{$p_1$}}{\marg{$p_2$}}{\marg{$p_3$}}{\marg{$p_4$}}{\marg{solutions}}}

  This command returns the intersection of a line $L$ (described by 
  the points $l_1$ and $l_2$) and a bezier curve $P$ (described by 
  the points $p_1$, $p_2$, $p_3$ and $p_4$). Solutions are ordered 
  according to their distance from $l_1$. If \meta{solution} is 
  greater than the number of intersections calculated, 
...
\begin{tikzpicture}
  ...
  \draw (-1,1.5) -- (3,0.5);
  \pgfpathcircle{
    \pgfpointintersectionoflineandcurve
      {\pgfpointxy{-1}{1.5}}{\pgfpointxy{3}{0.5}}
      {\pgfpointxy{0}{2}}{\pgfpointxy{0}{-1}}
      {\pgfpointxy{2}{-1}}{\pgfpointxy{2}{2}}
      {1}
  }{2pt}
