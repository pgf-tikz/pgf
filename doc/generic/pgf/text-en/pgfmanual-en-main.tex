...

{
  ...
  \begin{tikzpicture}[overlay]
    \shade [bottom color=white,top color=blue!80!black!50]
      (-.6\paperwidth,.325\paperheight) rectangle (.6\paperwidth,.6\paperheight);
    \shade [bottom color=black!70!green!25,top color=white]
      (-.6\paperwidth,0pt) rectangle (.6\paperwidth,.325\paperheight);
    \shade [top color=black!70!green!25,bottom color=black!25]
      (-.6\paperwidth,-5mm) rectangle (.6\paperwidth,1pt);
    \fill [black!25] 
      (-.6\paperwidth,-.6\paperheight) rectangle (.6\paperwidth,-5mm+1pt);
  ...
  \node [text width=\paperwidth-4cm,below right,at={(-.5\paperwidth+2cm,-2cm)}]
  {
    \fontfamily{pcr}
