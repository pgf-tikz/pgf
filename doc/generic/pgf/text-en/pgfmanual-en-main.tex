...
\ifluatex
  ...
  \usetikzlibrary{graphdrawing.standard}
\fi
...
%\include{pgfmanual-en-library-graphs}
\ifluatex
\include{pgfmanual-en-library-graphdrawing}
...
\include{pgfmanual-en-library-graphs}
\include{pgfmanual-en-library-graphdrawing}
\include{pgfmanual-en-tikz-matrices}% FIXME : resume spell-checking here (chap 17)
