...
\usepackage{pgflibrarypatterns}
\usepackage{pgflibraryplotmarks}
\usepackage{pgflibraryshapes}
\usepackage{pgflibrarysnakes}
\usepackage{pgflibrarytikzer}
\usepackage{pgflibrarytikz3d}
\usepackage{pgflibrarytikzautomata}
\usepackage{pgflibrarytikzbackgrounds}
\usepackage{pgflibrarytikztopaths}
\usepackage{pgflibrarytikztrees}
\usepackage{pgflibrarytikzpetri}
...
\tikzstyle{level 2}=
  [level distance=3.5mm, trunk!80!leaf,line width=.8ex,sibling angle=56]
\tikzstyle{level 3}=
  [level distance=2.75mm,trunk!60!leaf,line width=.6ex,sibling angle=52]
\tikzstyle{level 4}=
  [level distance=2mm,   trunk!40!leaf,line width=.4ex,sibling angle=48]
\tikzstyle{level 5}=
  [level distance=1mm,   trunk!20!leaf,line width=.3ex,sibling angle=44]
\tikzstyle{level 6}=
  [level distance=1.75mm,leaf,         line width=.2ex,sibling angle=40]
...
\newcommand{\tcslogo}[4]
{
  ...
  \begin{tikzpicture}
        ...
        child foreach \b in {0,1} {
          child foreach \c in {0,1} {
            child foreach \d in {0,1} {
              child foreach \e in {0,1} { edge from parent [-#4] }
            }
          }
        }
    ...
    { \textcolor{trunk}{T}heoretical \\
      \textcolor{trunk}{C}omputer \\
      \textcolor{trunk}{S}cience };
  \end{tikzpicture}
}
\begin{minipage}{3cm}
  \tcslogo{green!50!black}{green!25!black}{green}{leaf}\\
  \tcslogo{orange}{black}{green!50!black}{leaf}\\
  \tcslogo{red!75!black}{red!25!black}{red!75!black}{leaf}\\
  \tcslogo{black!50}{black}{black!50}{}
\end{minipage}
\end{codeexample}
