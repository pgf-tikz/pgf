...
\usetikzlibrary{arrows,catch,%
  patterns,plotmarks,shapes,snakes,er,3d,automata,backgrounds,topaths,trees,petri,mindmap,matrix,calendar,folding}
...
%\include{pgfmanual-en-library-catch}
%\end{document}
...
\tikz [nodes={circle,fill},
       very thick,cap=round,
       grow cyclic,level distance=13mm,level/.style={sibling angle=120/#1},
       edge from parent/.style={snake=expanding waves,segment length=1mm,segment angle=10,draw}]
