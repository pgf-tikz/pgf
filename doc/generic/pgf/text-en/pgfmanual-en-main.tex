...
%\include{pgfmanual-en-base-snakes-and-decorations}
%\end{document}
...

{
  ...
  \begin{tikzpicture}[overlay]
    ...
    \coordinate (sky) at (0,.6\paperheight);
    \coordinate (left) at (-.51\paperwidth,0);
    \coordinate (right) at (.51\paperwidth,0);
    
    \shade [bottom color=white,top color=blue!30!black!50]
      (horizon -|  left) rectangle (sky -| right);
    ...
    \shade [top color=black!70!green!25,bottom color=black!25]
      ([yshift=-5mm]front -| left) rectangle ([yshift=1pt]front -| right);
    \fill [black!25] (bottom -| left) rectangle ([yshift=-5mm]front -| right);

    \draw [white,very thin] (0,-2) -- (0,-12);
    ...
    \nodeshadowed [at={( 0,5.3)}] {\huge \textcolor{green!50!black!50}{\&}};
    ...
    \foreach \i in {0.5,0.6,...,2}
      \fill [white,decoration=Koch snowflake,opacity=\i/2]
        decorate { 
          decorate { 
            decorate { 
              (rand*11,11+rnd*5) -- ++(60:\i) -- ++(-60:\i) -- cycle
            }
          }
        };

     \path [circular glow={fill=yellow!30}] (11,17) circle (2);

  \node [text width=.5\paperwidth-2cm,below right,at={(-.5\paperwidth+1cm,-1.5cm)}]
  {
    \fontfamily{pcr}
    \def\textbraceleft{\char`\{}
    \def\textbraceright{\char`\}}
    \def\textbackslash{\char`\\}
    \begin{lstlisting}[basicstyle=\footnotesize\color{black},
...
\begin{tikzpicture}
  ...
  \draw [white,very thin] (0,-1) -- (0,-8);
  \end{lstlisting}
};

  \node [text width=.5\paperwidth-2cm,below right,at={(1cm,-1.5cm)}]
  {
    \fontfamily{pcr}
    \def\textbraceleft{\char`\{}
    \def\textbraceright{\char`\}}
  ...
  \foreach \i in {0.5,0.6,...,2}
    \fill [white,opacity=\i/2,
           decoration=Koch snowflake]
      decorate {
        decorate { 
          decorate { 
            (rand*11,11+rnd*5) -- ++(60:\i)
            -- ++(-60:\i) -- cycle
          } } };

  \path [circular glow={fill=yellow!30}]
      (11,17) circle (2);
\end{tikzpicture}
  \end{lstlisting}
  };
...
\include{pgfmanual-en-tikz-snakes-and-decorations}
