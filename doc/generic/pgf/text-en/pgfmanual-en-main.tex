...
%\includeonly{pgfmanual-en-math-commands}
...
\end{lstlisting}
  ...
  \foreach \where in {-9cm,9cm} {
    \nodeshadowed [at={(\where,5cm)}] { \tikz 
      \draw [xshift=\where,yshift=5cm,
             green!20!black, rotate=90,
             l-system={rules={F -> FF-[-F+F]+[+F-F]},
               axiom=F, order=4,step=2pt,
               randomize step=50, angle=30,
               randomize angle=5}] lindenmayer system; }}
