...
\tikz \graph [grid placement] { subgraph G_n [n=9] };
  \end{codeexample}
...
\begin{graph}{subgraph G\_n}
  ...
  \begin{key}{/tikz/graphs/wrap after=\meta{number}}
    ...
    edges created between the nodes of a |G_n| |subgraph| using
    different values for |wrap after|.
    \begin{codeexample}[]
\tikz \graph [grid placement] { subgraph G_n [n=3,wrap after=1] };
\tikz \graph [grid placement] { subgraph G_n [n=3,wrap after=3] };
    \end{codeexample}
    \begin{codeexample}[]
\tikz \graph [grid placement] { subgraph G_n [n=4,wrap after=2] };
\tikz \graph [grid placement] { subgraph G_n [n=4] };
    \end{codeexample}
  \end{key}
\end{graph}
