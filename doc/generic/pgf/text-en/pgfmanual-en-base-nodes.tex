...
\begin{command}{\pgfpositionnodelater\marg{macro name}}
  ...
  \end{command}
  \begin{command}{\pgfpositionnodelaterpostsetup}
    This macro should store ``post setup'' code. This code will be
    executed after the node has been positioned using
    |\pgfpositionnodenow|. As for the other macros, it the job of the
    caller of |\pgfpositionnodenow| to ensure that this macro has the
    same value as it had when |\pgfpositionnodelater| is called.

    This macro is set to the empty string at the beginning of each
    node. 
  \end{command}
...
\begin{command}{\pgfpositionnodenow\marg{coordinate}}
  ...
  \meta{coordinate}. Then, the macro |\pgfpositionnodelaterpostsetup|
