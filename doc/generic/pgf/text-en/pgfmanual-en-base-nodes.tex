...
\begin{tikzpicture}
  ...
  \fill (Test1.center) circle (2pt) node[above] {center anchor};
  \fill (Test1.anchor foo) circle (2pt) node[below] {anchor foo anchor};
  %
  \def\foo{bar}
  \node[simple shape] (Test2) at (2,2) {};
  \fill (Test2.center) circle (2pt) node[above] {center anchor};
  \fill (Test2.anchor foo) circle (2pt) node[below] {anchor bar anchor};
\end{tikzpicture}
\end{codeexample}
  \end{command}
