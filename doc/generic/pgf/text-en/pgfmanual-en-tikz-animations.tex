...
(``Formally,''
\meta{objects}|:|\meta{attributes}|_|\meta{id}|={|\meta{options}|}| is
transformed to |with| |=| |{object =| \meta{objects} |,| |attribute|
|=| \meta{attributes} |,| |id| |=| \meta{id} |}| |do|
|{|\meta{options}|}|, with the |object=|, |attribute=|, and |id=|
...
then the \meta{options} are executed inside this scope.
