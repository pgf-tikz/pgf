...
\item
  ...
  that it is also next to impossible to animate \emph{arrow tips}
  correctly. When you animate a path (that is, when you let a path
  change over time) you would expect the arrow tips to ``follow'' the
  path and to always point in the right direction. Unfortunately, due
  to the way arrow tips are currently implemented, this does not
...
\begin{tabular}{ll}
  ...
  |view|                      & view \\
  |visible|                   & boolean \\
  |xshift|, |yshift|          & dimension \\
  |xskew|, |yskew|            & scalar \\
  |xslant|, |yslant|          & scalar \\
\end{tabular}
...
name (and which just animate the attribute set using this key): 
\begin{itemize}
...
\begin{tikzanimateattribute}{fill}
...
\begin{tikzanimateattribute}{draw}
  See |:fill|.
\end{tikzanimateattribute}
...
\begin{tikzanimateattribute}{fill opacity}
...
\begin{tikzanimateattribute}{draw opacity}
  See |:fill opacity|.
\end{tikzanimateattribute}

\begin{tikzanimateattribute}{opacity}
...
\begin{tikzanimateattribute}{visible}
...
\begin{tikzanimateattribute}{stage}
...
\end{codeexample}
  ...
  off'' dimensions; see |\pgfsetdash| for details. Note that you
  \emph{must} specify the same number of 
