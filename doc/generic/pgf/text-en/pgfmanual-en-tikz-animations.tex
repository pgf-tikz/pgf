...
\end{codeexample}
  ...
  \begin{key}{/tikz/animate/options/along=\marg{path}\meta{|sloped| or
    ...
    shift the object by the coordinates along the \meta{path}. When
...
\end{codeexample}
  ...
  Following the \meta{path}, which must be put in braces, you must
...
\end{codeexample}
  ...
  for |0s| to |"0"| and the value for some specific \meta{time} to
...
\tikz {
  ...
  \node [animate me = { :rotate = { 0s="0", 2s="45", begin on=click} }]
...
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,2.2);
  \scoped [animate me = {:rotate = { 0s="0", 2s="45",
                                     begin on={click, of next=n}}}]
...
\begin{key}{/tikz/animate/options/origin=\meta{coordinate}}
  Shifts the animation coordinate system by \meta{coordinate}. This
...
\begin{key}{/tikz/animate/options/transform=\meta{transformation keys}}
  ...
  |cm|. In particular, |origin=|\meta{c} has the same effect as
  |transform| |=| |{shift=|\meta{c}|}|. Note that the transformation
...
\tikz {
  ...
  \node [animate me = {:position = { 0s="{(1,.5)}", 2s="{(1.5,0)}",
                                     begin on=click}}]
    at (1,.5) [fill = blue, opacity=.5, circle] {Click};
}
\end{codeexample}
...
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,1.2);
  \draw (1,.5) circle [radius=1mm] (1.5,0) circle [radius=1mm];
  \node [animate me = {:shift = { 0s="{(1,.5)}", 2s="{(1.5,0)}",
                                  begin on=click}}]
    at (1,.5) [fill = blue, opacity=.5, circle] {Click};
}
\end{codeexample}
  You can use the |along| key with |:position| in the same way as with
  |:shift|, which is especially useful for specifying that a node
  ``travels'' between positions of the canvas:
\begin{codeexample}[animation list={0.5,1,1.5,2}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,1.2);
  \draw (1,1) circle [radius=1mm] (1.5,0) circle [radius=1mm];
  \node [animate me = {:position = {
...
\begin{codeexample}[animation list = {0.5,1,1.5,2,2.5}]
\tikz \node [fill = green!50!black, text = white, animate me = { :fill =
    { 1s = "red", 2s = "blue", forever, begin on = click } } ]
  {Click me};
\end{codeexample}
\begin{codeexample}[animation list = {0.5,1,1.5,2,2.5}]
\tikz \node [fill = green!50!black, text = white, animate me = { :fill =
    { 1s = "red", 2s = "blue", begin on = click } } ]
  {Click me};
\end{codeexample}
\end{key}
...
The \meta{time} used with the first use of the |entry| key in a
timeline is the start time and the \meta{time} in the last |entry| key
...
\begin{codeexample}[]
\tikz \node [fill = green!50!black, text = white, animate me = {
...
\tikz [very thick] {
  ...
  \node (node) [animate me = {:rotate = {0s="0", 2s="90",
                                         begin on = {click, of = X}}},
...
\begin{codeexample}[width=2cm]
\tikz 
  \node [animate me = { :rotate = { 0s="0", 2s="90",
                                    begin on = {click} }},
...
\tikz 
  \node [animate me = {
    :rotate = { 0s="0", 2s="90", begin on = {begin, of next = anim } },
    :xshift = { 0s="0mm", 2s="5mm", begin on = {click}, name = anim } },
    fill = blue!20, draw = blue, circle, ultra thick] {Here!}; 
\end{codeexample}
    \end{key}
...
\tikz 
  \node [animate me = {
    :rotate = { 0s="0", 2s="90", begin on = {end, of next = anim } },
    :xshift = { 0s="0mm", 2s="5mm", begin on = {click}, name = anim } },
    fill = blue!20, draw = blue, circle, ultra thick] {Here!}; 
\end{codeexample}
    \end{key}
...
\begin{codeexample}[width=2cm]
\tikz 
  \node [animate me = { :rotate = { 0s="0", 2s="90", restart = false,
                                    begin on = {click} }},
         fill = blue!20, draw = blue, circle, ultra thick] {Here!}; 
\end{codeexample}  
...
\begin{codeexample}[animation list={1,2,3,4,5}]
\tikz 
  \node [animate me = { :rotate = { 0s = "0", 2s = "90", begin on = click,
...
\begin{key}{/tikz/animate/options/exit control=\marg{time
...
\begin{key}{/tikz/animate/options/entry control=\marg{time
      fraction}\marg{value fraction}}
  Works like |exit control|.
\end{key}
  
\begin{key}{/tikz/animate/options/ease ine=\marg{fraction} (default 0.5)}
  A shorthand for |entry control={1-|\meta{fraction}|}{1}|.
\end{key}

\begin{key}{/tikz/animate/options/ease oute=\marg{fraction} (default 0.5)}
...
\tikz {
  \foreach \i in {0,0.1,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \node [animate me = { :yshift = { begin on = click, ease,
                                    0s = "0cm", 2s = "-10mm" } },
         fill = blue!20, draw = blue, very thick, circle] {Click me!}; 
}
\end{codeexample}
...
\tikz {
  \foreach \i in {0,0.1,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \node [animate me = { :yshift = { begin on = click,
                                    0s = "0cm",
                                    1s = {stay, "-5mm"},
                                    2s = "-10mm" } },
         fill = blue!20, draw = blue, very thick, circle] {Click me!}; 
