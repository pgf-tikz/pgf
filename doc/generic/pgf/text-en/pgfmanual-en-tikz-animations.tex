...
Let us have a look at some examples. First, we use the syntax to set
...
\begin{key}{/tikz/animate/arrows=\meta{arrow spec}}
  ...
  arrow tips specified in \meta{arrow spec} to be added to the path
...
The attributes for specifying transformations and, in particular, the
