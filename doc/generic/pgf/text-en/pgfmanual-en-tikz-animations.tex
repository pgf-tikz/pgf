...
\end{codeexample}
  ...
  \begin{key}{/tikz/animations/option/begin snapshot=\meta{start time}}
    ...
    timeline the \meta{start time} is subtracted from the snapshot's
    \meta{time} when the value needs to be determined:
\begin{codeexample}[]
\tikz [make snapshot of = 1s] {
  \fill [animate me = { :fill = { 0s = "black", 2s = "white",
                                  begin snapshot = 1s } }]
...
\subsubsection{Specifying Timelines: Syntax for Values}
