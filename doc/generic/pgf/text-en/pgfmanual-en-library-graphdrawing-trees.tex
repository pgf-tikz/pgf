...
Currently, however, the choice of algorithms avaible in this library
is somewhat limited, since noone has yet found the time and energy to
implement some advanced algorithms. Hopefully, this will change soon.



\subsection{Layout Reference}
