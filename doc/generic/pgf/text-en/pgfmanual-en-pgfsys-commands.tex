...
The system layer follows the following philosophy: An animation always
...
In the following examples, two macros are used. Both take take three
parameters: The \pgfname/\tikzname\ name of a to-be animated object, a
type (relevant for objects that have subtypes or parts), and some code
...
\animationexample{node}{}{
  \pgfsys@animation@val@dimension{10pt}
  \pgfsys@animatedashphase
  \pgfsetdash{{3pt}{1pt}}{0pt}
}
\end{codeexample}
\end{command}
...
\animationtimingexample{node}{}{
  \pgfsys@animation@time{0}{1}{1}{0}{0}
  \pgfsys@animation@val@dashpattern{1pt,10pt}
  \pgfsys@animation@time{2}{1}{1}{0}{0}
  \pgfsys@animation@val@dashpattern{10pt,3pt}
  \pgfsys@animatedashpattern
}
\end{codeexample}
\end{command}
...
\animationexample{my view}{view}{
  ...
  \scoped [xshift=2cm] {
    ...
    \scoped [meet={view (-1,-2) (1,2)}, name=my view]  {
...
\begin{command}{\pgfsys@animation@val@dashpattern\marg{pattern}}
...
\animationtimingexample{node}{}{
  ...
  \pgfsys@animatetranslate 
  \pgfsys@animatetranslate % Second animation adds to first
}
\end{codeexample}
\end{command}
...
\animationtimingexample{node}{}{
  ...
  \pgfsys@animatetranslate 
  \pgfsys@animatetranslate % Second animation overrides first
}
\end{codeexample}
\end{command}
