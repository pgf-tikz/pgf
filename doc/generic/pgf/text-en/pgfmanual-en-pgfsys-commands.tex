...
\tikz[fill=blue!25, draw=blue, ultra thick] {
  \pgfidrefnextuse{\nodeid}{node} \pgfsys@animation@whom{\nodeid}{}
  \pgfsys@animation@dur{2} \pgfsys@animation@event{}{}{click}{}{begin}
  \pgfsys@animation@origin{1cm}{1cm}
  \pgfsys@animation@scale{1}{1}{from}
  \pgfsys@animation@scale{0.5}{2}{to}
  \pgfsys@animatescale
  \node [circle, fill, draw, align=center] (node) {Click \\ here}; }
...
\begin{command}{\pgfsys@animation@whom\marg{1}\marg{2}}
  To be written\dots
% % Sets the target of the animation. \marg{1} must be an id previously
% % created using \pgfsys@new@id and \marg{2} must be empty or a type
% % previously created using \pgfsys@new@id@type
\end{command}

\subsubsection{Commands for Specifying Timing}
...
\begin{command}{\pgfsys@animation@keytime\marg{1}{}}
  To be written\dots
