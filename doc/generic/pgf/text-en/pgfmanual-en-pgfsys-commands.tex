...
The system layer follows the philosophy of \textsc{svg}'s animation
...
\tikz[fill=blue!25, draw=blue, ultra thick] {
  \node [circle, fill, draw, align=center] {Click \\ here};
...
\tikz[fill=blue!25, draw=blue, ultra thick] {
  \node [circle, fill, draw, align=center] {Click \\ here};
  \pgfsys@animation@dur{2} \pgfsys@animation@event{}{}{click}{}{begin}
  \pgfsys@animation@scalar{hidden}{to}
...
\tikz {
  ...
  \pgfsys@animation@dur{2} \pgfsys@animation@event{\pgfrefid{my path}}{}{click}{}{begin}
  \pgfsys@animation@whom{\pgfrefid{my path}}{path}
...
\tikz[fill=blue!25, draw=blue, ultra thick] {
  \node [circle, fill, draw, align=center] {Click \\ here};
  \pgfsys@animation@dur{2} \pgfsys@animation@event{}{}{click}{}{begin}
  \pgfsys@animation@dimension{10pt}{to}
...
\tikz[fill=blue!25, draw=blue, ultra thick] {
  \node [circle, fill, draw, align=center] {Click \\ here};
  \pgfsys@animation@dur{2} \pgfsys@animation@event{}{}{click}{}{begin}
  \pgfsys@animation@rotate{90}{0cm}{0cm}{to}
...
\tikz[fill=blue!25, draw=blue, ultra thick] {
  \node [circle, fill, draw, align=center] {Click \\ here};
  \pgfsys@animation@dur{2} \pgfsys@animation@event{}{}{click}{}{begin}
  \pgfsys@animation@rotate{90}{1cm}{0cm}{to}
  \pgfsys@animaterotate }
\end{codeexample}
\end{command}
...
\tikz[fill=blue!25, draw=blue] {
  ...
  \begin{scope}[meet={view (-1,-1) (1,1)}, name=my view] 
    \node (c) [circle, fill, draw, align=center, ultra thick] {Click \\ here};
    \draw (-5mm,-5mm) rectangle (7mm,8mm);  
  \end{scope}
  \pgfsys@animation@dur{2} \pgfsys@animation@event{}{}{click}{}{begin}
  \pgfsys@animation@whom{\pgfrefid{my view}}{view}
...
\subsubsection{Command for Specifying Timing}
...
\begin{tikzpicture}[fill=blue!50,semithick] 
  \showclock
  \begin{scope}[xshift=-1cm, yshift=-2cm, x=5mm]
    \foreach \i in {0,...,5} 
      \draw (\i,-1mm) -- ++(0,2mm) node [above,font=\tiny] {\i s};
    \begin{scope}
      \fill [red] circle[radius=0.75mm];
      \pgfsys@animation@event{\pgfrefid{clock}}{}{click}{}{begin}
...
\subsubsection{Command for Specifying Values and their Accumulation}
