...
\begin{key}{/tikz/name path=\meta{name}}
...
\begin{key}{/tikz/intersect/name=\meta{prefix} (initially intersection)}
  This key specifies the prefix name for the coodinate nodes placed
  at each intersection.
\end{key}

\begin{key}{/tikz/intersect/total=\meta{macro}}
...
\end{codeexample}
  ...
  \begin{key}{/tikz/intersect/by=\meta{comma-separated list}}
