...
\tikz \graph [spring electrical layout,orientation=(a):(b)] { a -- b -- c -- a };
\tikz \graph [spring electrical layout,orientation=(b):(a)] { a -- b -- c -- a };
...
\tikz \graph [spring electrical layout,orientation=(4):(1)] { subgraph K_n[n=5] };
  ...
  \begin{codeexample}[]
\tikz \graph [spring electrical layout,orientation=(a):90:(b)]  { a -- b -- c -- a };
\tikz \graph [spring electrical layout,orientation=(a):45:(b)]  { a -- b -- c -- a };
\tikz \graph [spring electrical layout,orientation=(a):0:(b)]   { a -- b -- c -- a };
\tikz \graph [spring electrical layout,orientation=(a):-45:(b)] { a -- b -- c -- a };
\tikz \graph [spring electrical layout,orientation=(a):-90:(b)] { a -- b -- c -- a };
  \end{codeexample}
\end{key}

\begin{key}{/tikz/orientation'=|(|\meta{first axis node}|)|\opt{|:|\meta{angle}}|:(|\meta{second axis-node}|)|}
