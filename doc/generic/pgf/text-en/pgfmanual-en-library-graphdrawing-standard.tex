...
\begin{key}{/tikz/random seed=\meta{number} (initially 0)}
  ...
  \begin{codeexample}[]
\tikz \graph [spring layout,positioning=random,random seed=1] { 
  subgraph K_n[n=4]
};
\tikz \graph [spring layout,positioning=random,random seed=2] { 
  subgraph K_n[n=4]
};
  \end{codeexample}
\end{key}
...
\begin{key}{/tikz/coarsening/independent set=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}

\begin{key}{/tikz/coarsening/independent set injection=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}

\begin{key}{/tikz/coarsening/independent set ruge stuben=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}

\begin{key}{/tikz/coarsening/independent set ruge stuben injection=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}

\begin{key}{/tikz/coarsening/independent edge set=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}

\begin{key}{/tikz/coarsening/independent edge set heavy=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}

\begin{key}{/tikz/coarsening/independent edge set small node weight=\opt{\meta{boolean}}
  (default true, initially false)}
\end{key}
