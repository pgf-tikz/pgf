...
There is a parameter for handled keys which proves to be useful in some (possibly rare) special cases:
...
The command |\pgfkeyssetdefaultpathforhandled| can be used to change the default key path for handled keys (only). For example, 
\begin{codeexample}[code only]
