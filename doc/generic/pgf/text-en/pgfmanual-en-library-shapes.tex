...
\end{codeexample}	
	...
	node contents, but can only be drawn pointing in 
	one of four directions:	up, down, left and right. This should
	be viewed as rotating the triangle border by 90, 270, 180 and 0
	degrees, respectively, and this rotation is \emph{independent} of
	the node contents.
