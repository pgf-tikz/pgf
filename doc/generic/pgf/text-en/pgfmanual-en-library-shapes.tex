...
\begin{shape}{rectangle split}
  ...
  two, three or four node parts, or simply used with a single node 
  part. 
...
\end{codeexample} 
  ...
  The rectangle split will observe any |minimum width| requirements
  but |minimum height| will be ignored. Also, |inner sep| is applied 
...
\end{codeexample} 
  ...
  \begin{key}{/pgf/rectangle split ignore empty parts=\opt{\meta{boolean}} (default true)}
    ...
    This effectively overrides the previous key in that, if 
