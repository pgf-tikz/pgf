...
\begin{key}{/pgf/mark color=\marg{color} (initially empty)}
	Defines the additional fill color for the |halfcircle|, |diamondfd| and |tiltsfl| markers. An empty value uses |white| (which is the initial configuration).       % TODOsp: diamondfd and tiltsfl seem to be renamed. Please have a look
\end{key}
