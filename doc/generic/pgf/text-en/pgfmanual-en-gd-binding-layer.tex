...
In the following, I first present a simple example of a binding to a
more or less imaginary display system. Then comes the detailed
documentation of the |Binding| class in
Section~\ref{section-gd-binding-doc}. At the end, the 
the particulars of the binding to \pgfname\ are detailed.
