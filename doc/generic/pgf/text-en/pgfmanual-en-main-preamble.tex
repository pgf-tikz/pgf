...
\csname setupcanlinkcode\endcsname % set this to \canlinkcodetrue in
                                % your master file to include C stuff

\ifcanlinkccode
\usegdlibrary{pgf_gd_examples_c_SimpleDemoC,pgf_gd_examples_c_SimpleDemoCPlusPlus,pgf_gd_ogdf_c_SimpleDemoOGDF}
\usegdlibrary{ogdf}
\fi
