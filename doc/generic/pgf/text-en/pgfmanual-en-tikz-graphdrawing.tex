...
|drawGraphAlgorithm_|\meta{algorithm name} inside the
|pgf.graphdrawing| Lua module. This function, in turn, should
typically be placed in a file called |pgfgd-algorithm-|\meta{algorithm
  name}. In theory, this would already be sufficient to use the
...
\tikzset{circular layout/.style={
    graph drawing scope,
    /graph drawing/algorithm=simpleexample}}
\end{codeexample}
