...
\pgfgdset{radius/.graph drawing parameter initial=1cm}
...
\begin{codeexample}[code only]
\pgfgddeclarecommonkeys{radius/.graph drawing graph parameter=evaluate math expression}
\pgfgdset{radius/.graph drawing parameter initial=1cm}
\end{codeexample}
...
keys that have not been set. While this sometimes the desired
