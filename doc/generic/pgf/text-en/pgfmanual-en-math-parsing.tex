...
\begin{command}{\pgfmathpostparse}
  ...
  Although no longer officially supported (and no longer required by
...
These operators are used to quote \meta{text}. However, as every
...
The following functions were adapted from code suggested by Martin
Heller:
