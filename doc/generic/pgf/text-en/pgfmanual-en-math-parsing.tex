...
posible to change the algorithms as described in
...
The syntax for the expressions recognised by |\pgfmathparse| and
friends is based on the syntax recognised by \textsc{matlab}. The
