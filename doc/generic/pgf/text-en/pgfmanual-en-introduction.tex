...
\begin{description}
    ...
    \item[Basic layer:] The basic layer provides a set of basic commands that
        ...
        using the system layer directly. For example,  the system layer
        provides no commands for creating circles since circles can be
        composed from the more basic B\'ezier curves (well, almost). However,
        as a user you will want to have a simple command to create circles
