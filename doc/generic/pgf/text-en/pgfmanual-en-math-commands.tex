...
\begin{command}{\pgfmathdivide\marg{x}\marg{y}}        
	Defines |\pgfmathresult| as $\meta{x}\div\meta{y}$. Please remember
	when using this command that accurate (and reasonably quick) 
...
\begin{command}{\pgfmathln\marg{x}}                
	...
	suggested by Rouben Rostamian, and coefficients contributed by
	Alain Mathes.             
\end{command}
