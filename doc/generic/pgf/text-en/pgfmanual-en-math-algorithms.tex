...
\begin{command}{\pgfmathdeclarefunction\opt{|*|}\marg{name}\marg{number of arguments}\marg{code}}
    ...
    function. Note that you \emph{should never change the arity \todosp{correct typo} of
    standard functions} and you should normally use |\pgfmathredeclarefunction|,
