...
\begin{tikzpicture}
  ...
  \draw [-to,thick,decorate,decoration={snake,amplitude=.4mm,segment length=2mm,post length=1mm}]
...
library with the ``snaking line'' in the middle, the background
library for the two rectangular areas that are behind the two main
parts of the picture, and the |placements| library for placing nodes
...
\usepackage{tikz}
\usetikzlibrary{arrows,decorations.pathmorphing,backgrounds,placments}
