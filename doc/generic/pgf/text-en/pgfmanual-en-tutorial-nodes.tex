...
\begin{tikzpicture}[node distance=1.3cm,>=stealth',bend angle=45,auto]
  ...
  \begin{scope}
    ...
    \node [place] (s)  [below of=c1] {}; \node [above,red] at (s.north) {$s\le 3$};
  ...
  \begin{scope}[xshift=6cm]
    ...
    \node [place]     (w1')                            {};
    \node [place]     (c1') [below of=w1']             {};
    \node [red place] (s1') [below of=c1',xshift=-5mm] {}; \node [left,red]  at (s1'.west) {$s$};
    \node [red place] (s2') [below of=c1',xshift=5mm]  {}; \node [right,red] at (s2'.east) {$\bar s$};
...
Let us now put everything together. The code for the net starts as
follows:
