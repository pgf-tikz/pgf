...
%
\begin{codeexample}[preamble={\usetikzlibrary{arrows}}]
...
\end{tikzpicture}
\end{codeexample}
% TODOsp: styles and `positioning` are needed up to here


% TODOsp: `decorations.pathmorphing` is needed in this subsection (only)
...
%
% TODOsp: redo/add styles starting from here
\begin{codeexample}[
