...
\begin{command}{\pgfsetplotbarwidth\marg{dimension}}
Sets the width of any bar plot handler to \marg{dimension}.
\end{command}

\begin{command}{\pgfplotbarwidth}
Expands to the last value set by |\pgfsetplotbarwidth|.
\end{command}
