...
decoration.}:
%
% TODOsp: maybe these can be moved to the second `tikzpicture`,
%         because the definitions are included in the `codeexamples`
\tikzset{
  nonterminal/.style={
    % The shape:
    rectangle,
...
%
\begin{codeexample}[
    libraries/tikz={calc,positioning,shapes.misc},
    pre={\tikzset{
    terminal/.style={
      % The shape:
      rounded rectangle,
...
%
\begin{codeexample}[
    libraries/tikz={positioning,shapes.misc},
    pre={\tikzset{
    terminal/.style={
      % The shape:
      rounded rectangle,
...
%
% TODOsp: maybe these can now be deleted (or at least moved),
%         because the definitions are included in the `codeexamples`
\tikzset{terminal/.append style={text height=1.5ex,text depth=.25ex}}
\tikzset{nonterminal/.append style={text height=1.5ex,text depth=.25ex}}
%
...
%
\begin{codeexample}[
    libraries/tikz={graphs,shapes.misc},
    pre={\tikzset{
    terminal/.style={
      % The shape:
      rounded rectangle,
...
%
\begin{codeexample}[
    libraries/tikz={arrows,graphs,shapes.misc},
    pre={ % !!! replace `##1` with `#1` in `skip loop` style
\tikzset{
    terminal/.style={
      % The shape:
      rounded rectangle,
...
%
\begin{codeexample}[libraries/tikz={arrows,graphs,shapes.misc}]
