...
% TODOsp: missing styles and definition
\begin{codeexample}[
...
%
% TODOsp: missing styles and definition; `##1` --> `#1`
\begin{codeexample}[
    pre={
        \tikzset{
            ampersand replacement=\&,point/.style={coordinate},
            skip loop/.style={to path={-- ++(0,##1) -| (\tikztotarget)}},
            hv path/.style={to path={-| (\tikztotarget)}},
            vh path/.style={to path={|- (\tikztotarget)}},
        },
