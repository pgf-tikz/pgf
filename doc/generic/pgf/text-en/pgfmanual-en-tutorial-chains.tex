...
\tikz \graph [grow right sep] {
  unsigned integer[nonterminal] -> d__.[terminal] -> digit[terminal] -> E[terminal]
};  
\end{codeexample}
...
\tikz \graph [grow right sep] {
  ...
  {
    plus__+           [terminal],
    nothing__         [coordinate],
    minus__{-}        [terminal]
  } ->
  ui2__unsigned integer [nonterminal]
};  
\end{codeexample}
...
\begin{tikzpicture}[>=stealth', thick, black!50, text=black,
  ...
  \graph [grow right sep, branch down=7mm] {
    ...
    q3                 [coordinate] --
    __unsigned integer [nonterminal] --
    p6                 [coordinate] ->
    __                 [coordinate];
...
\tikz [>=stealth', black!50, text=black, thick,
  ...
  \graph [grow right sep, branch down=7mm, simple] {
    __ -> unsigned integer[nonterminal] -- p1 -> __. [terminal] -- p2 -> digit[terminal] --
    p3 -- p4 -- p5 -> E[terminal] -- q1 ->[vh path]
    {[nodes={yshift=7mm}]
      __+[terminal], q2, __{-}[terminal]
    } -> [hv path]
    q3 -- __unsigned integer [nonterminal] -- p6 -> __;
