...
\end{codeexample}
  ...
  transparency group and set a blend mode simultaneously:
...
\end{codeexample}
  ...
  modes. In the examples, we start with always three circles drawn on
...
\end{codeexample}
   ...
   shading, the shading withh ``shine through'' at the knocked-out
   pixels.
