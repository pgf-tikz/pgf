...
because they look a little bit like snakes seen from above. Since
snakes are a little more complicated to use, they are documented in a
separate Section~\ref{section-tikz-snakes}.

The following examples intend to show what can be done with snakes, in
principle:
