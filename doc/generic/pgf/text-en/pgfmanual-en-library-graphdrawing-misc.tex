...
Currently, in this library there is only the following algorithm:

\begin{gdalgorithm}{AhrensFKSS2011 minimize crossings}{AhrensFKSS2011 minimize crossings}
  This algorithm was created by Ahrens, Frahm,
  Kluttig, Schulz, and Schuster, who have implemented the
  graph   drawing engine, for demonstration purposes. It is not really
  useful in practice.
\end{gdalgorithm}
