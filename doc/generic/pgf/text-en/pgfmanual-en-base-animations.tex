...
\end{codeexample}
  ...
  \begin{key}{/pgf/animation/paced=\meta{optional timing}}
    ...
    \begin{enumerate}
    \item You leave the \meta{optional timing} empty. In this case,
      ...
      are ignored.
    \item You explicitly set the \meta{optional timing} to either a
      simple time (like |paced = 3s|) which makes the timeline start
      at 0\,s and end after 3\,s or you use the syntax \meta{start
        time}| to |\meta{end time} as in |paced = 1s to 3s|.
    \end{enumerate}
\begin{codeexample}[width=2.3cm]
\tikz {
  \pgfanimateattribute{translate}{
