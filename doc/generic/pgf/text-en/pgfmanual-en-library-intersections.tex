...
\begin{key}{/tikz/intersect named paths=\meta{name 1}| |and| |\meta{name 2}}
...
\begin{tikzpicture}[every node/.style={opacity=1, circle, black, above left}]
  ...
  \fill [red, opacity=0.5, intersect named paths=curve 1 and curve 2]
...
\begin{tikzpicture}[every node/.style={opacity=1, circle, black, above left}]
  ...
  \tikzset{intersect named paths=circle and rectangle}
