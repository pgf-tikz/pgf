...
\begin{command}{\pgfcalendardatetojulian\marg{date}\marg{counter}}
  ...
  the Gregorian calendar. The \meta{date} should expand to a string of the form
  ...
  Normally, the month and date inside the \meta{date} should have a
  leading zero, but this is not necessary. Thus, the date |2006-1-31|
  for the last day of January 2006 is also legal (but not nice).

  Additionally, the day part of the \meta{date} can be replaced by the
  keyword |last|. This refers to the last day of that month. Thus,
  |2000-02-last| is the same as |2000-02-29|.
