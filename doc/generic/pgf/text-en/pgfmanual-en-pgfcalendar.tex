...
\pgfcalendar{cal}{2007-01-01}{2007-02-28}{%
  \ifdate{day of month=1}{
    \par\bigskip\hbox to7.5cm{\itshape\hss\pgfcalendarmonthname{\pgfcalendarcurrentmonth}\hss}\par
  }{}%
  \leavevmode%
  {%
    ...
    \hbox to0pt{%
      ...
      \hbox to1cm{\hss\pgfcalendarnoleadingzero{\pgfcalendarcurrentday}}\hss%
    }%
  }%
  \ifdate{Sunday}{\par}{}%
}    
