...
\begin{command}{\pgfdeclarepattern\marg{config}}
    ...
    %
\begin{key}{/pgf/patterns/name=\meta{name} (default empty)}
...
\end{key}
    %
\begin{key}{/pgf/patterns/bottom left=\meta{pgfpoint} (default \string\pgfpointorigin)}
    Bottom left corner of the pattern's bounding box, e.g.\
    |\pgfqpoint{-.1pt}{-.1pt}|.
\end{key}
    %
\begin{key}{/pgf/patterns/top right=\meta{pgfpoint} (default \string\pgfpointorigin)}
    Top right corner of the pattern's bounding box, e.g.\
    |\pgfqpoint{3.1pt}{3.1pt}|.
\end{key}
    %
\begin{key}{/pgf/patterns/tile size=\meta{pgfpoint} (default \string\pgfpointorigin)}
...
\end{key}
    %
\begin{key}{/pgf/patterns/code=\meta{code} (default empty)}
