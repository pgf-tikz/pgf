...
ofter even necessary to define new axis systems. Doing so involves the
following steps:
...
The first step used |new ... axis| keys to create new axes, the
...
We must new visualize the axes themselves. For this we can use the
|visualize axis| key:

\begin{key}{/tikz/data visualization/axis options/visualize axis=\meta{options}}
  This key is used to create a visual representation of an axis. To be written... 
\end{key}
...
\begin{key}{/tikz/data visualization/axis options/padding min=\meta{dimension}}
  ...
  \meta{dimension} should be added at the minimum of the
  axis. Note that \meta{dimension} should typically be negative since
...
\begin{key}{/tikz/data visualization/grid style=\meta{\tikzname\ options}}
