...
\begin{key}{/tikz/data visualization/axis options/label=\opt{|[|\meta{options}|]|}\meta{text}}
  ...
  \meta{options} are given, everything following the equal sign should
...
\begin{key}{/tikz/data visualization/new polar axes=\meta{angle axis
      name}\meta{radius axis name}}
