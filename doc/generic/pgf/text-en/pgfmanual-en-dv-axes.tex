...
\begin{key}{/tikz/data visualization/about=\meta{number}}
  ...
  ten. The following examples shows the effects of, first, setting
  |about=5| and then having axes where the minimum value is always |0|
  and where the maximum value ranges from |10| to |100| and, second,
  setting |about| to values from |1| to |10| while always having the
