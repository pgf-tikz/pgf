...
\begin{key}{/tikz/every child (initially \normalfont empty)}
...
\end{codeexample}
  ...
  \begin{key}{/tikz/child anchor=\meta{anchor} (initially \normalfont empty)}
...
\end{codeexample}
  ...
  \begin{key}{/tikz/parent anchor=\meta{anchor} (initially \normalfont empty)}
  ...
  \begin{key}{/tikz/edge from parent (default draw)}
