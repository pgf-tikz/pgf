...
%  0pt)}
%  Specifies a distance beyond which the attractive and electric forces 
...
\begin{key}{/graph drawing/node distance=\meta{dimension} (initially 1cm)}
  ...
  \begin{codeexample}[width=5cm]
\tikz \graph [spring layout, node distance=7mm]
  { subgraph C_n[n=3] };

\tikz \graph [spring layout]
  { subgraph C_n[n=3] };

\tikz \graph [spring layout, node distance=15mm]
  { subgraph C_n[n=3] };
  \end{codeexample}
  ...
  algorithms:
  \begin{codeexample}[width=5cm]
\tikz \graph [spring electrical layout, node distance=0.7cm]
  { subgraph C_n[n=3] };

\tikz \graph [spring electrical layout]
  { subgraph C_n[n=3] };

\tikz \graph [spring layout, node distance=1.5cm]
  { subgraph C_n[n=3] };
  \end{codeexample}
\end{key}
...
\subsubsection{Common Edge Options}
...
% TODO Jannis: Document this option.
%\begin{key}{/graph drawing/spring layout/electric force
