...
\begin{tikzpicture}[decoration={text effects along path, 
  ...
  text effects/.cd,
    character variable=\i, character total variable=\n,
...
\begin{key}{/pgf/decoration/text effects/character variable=\meta{macro}}
  This key stores the number of the character being typeset in \meta{macro}.
...
\begin{tikzpicture}[decoration={text effects along path,
  ...
  text effects/.cd,
    path from text, 
    character variable=\i, every word separator/.style={fill=red!30},
...
\begin{key}{/pgf/decoration/text effects/character total variable=\meta{macro}}
  This key stores the total number of the characters in \meta{macro}.
  This key can be used with the |character variable| key to produce
...
\begin{key}{/pgf/decoration/letter variable=\meta{macro}}
...
\begin{tikzpicture}[decoration={text effects along path,
  ...
  text effects/.cd,
    path from text, 
    letter variable=\i, every word separator/.style={fill=red!30},
    characters={text along path, shape=circle, fill=gray!50}}]
\path [decorate, text effects={characters/.append={label=above:\footnotesize\i}}] (0,0);
\end{tikzpicture}
\end{codeexample}
...
\begin{key}{/pgf/decoration/letter total variable=\meta{macro}}

  This key stores the number of letters in the current word in \meta{macro}.
  When the character is the word separator, this value is 0.

\end{key}

\begin{key}{/pgf/decoration/text effects/word variable=\meta{macro}}
   This key stores the number of word in the text
     \meta{macro}. Numbering starts at 1.
     When the character is the word separator, \meta{macro}
     takes the number of the previous word.
...
\begin{tikzpicture}[decoration={text effects along path,
  ...
  text effects/.cd,
    path from text,
    word variable=\i, every word separator/.style={fill=red!30},
    characters={text along path, shape=circle, fill=gray!50}}]
 \path [decorate, text effects={characters/.append={label=above:\footnotesize\i}}] (0,0);
\end{tikzpicture}
\end{codeexample}
...
\begin{key}{/pgf/decoration/word total variable=\meta{macro}}

  This key stores the number of words in the current text in \meta{macro}.
...
\begin{key}{/pgf/decoration/text effects/path from text=\opt{\marg{true or false}} (default true)}
  ...
  the width of the decoration text using all they specified parameters
...
\begin{key}{/pgf/decoration/text effects/reverse text}
  ...
  This may be useful if using `right-to-left` languages. Note
  that leading `soft' spaces in the original text will be lost.
