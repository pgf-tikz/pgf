...
\begin{decoration}{Koch curve type 1}
  ...
  5/\log 3$.
\begin{codeexample}[]
\begin{tikzpicture}[decoration={name=Koch curve type 1}]
...
\begin{codeexample}[]
\begin{tikzpicture}[decoration={name=Koch curve type 2}]
  \draw decorate{ (0,0) -- (3,0) };
...
\begin{codeexample}[]
\begin{tikzpicture}[decoration={name=Koch snowflake}]
  \draw decorate{ (0,0) -- (3,0) };
...
\begin{decoration}{Cantor set}
  ...
  2/\log 3$. 
\begin{codeexample}[]
\begin{tikzpicture}[decoration={name=Cantor set},very thick]
  \draw decorate{ (0,0) -- (3,0) };
