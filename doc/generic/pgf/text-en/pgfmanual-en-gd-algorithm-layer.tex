...
The standard syntax of the documentation string is as follows: 
...
Each vertex can have a  different radius. % Part of the documentation,
                                          % not of the Summary
...
\includeluadocumentationof{pgf.gd.interface.DocumentationParser}
