...
\end{luacommand}
\begin{luacommand}{{countKeys}(\meta{table})}
...
\end{luacommand}
\begin{luacommand}{{filter}(\meta{iterator},\meta{test})}
Returns all results from iterator for which test returns a true value.



\end{luacommand}
\begin{luacommand}{{findTable}(\meta{table},\meta{object})}
...
\end{luacommand}
\begin{luacommand}{{keys}(\meta{map})}
...
\end{luacommand}
\begin{luacommand}{{mergeTable}(\meta{values},\meta{defaults})}
...
\end{luacommand}
\begin{luacommand}{{values}(\meta{table})}
