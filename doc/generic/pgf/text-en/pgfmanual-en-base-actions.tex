...
\begin{command}{\pgfsetstrokeopacity\marg{value}}
  ...
  \emph{Note:} For PostScript output, opacity is rendered correctly
  only with the most recent versions of GhostScript. Printers and
  other programs will ignore the opacity setting.
