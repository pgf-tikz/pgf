...
\begin{command}{\pgfprofilenewforenvironment\marg{environment name}}
	Defines a new profiler entry which measures time spent in the environment \meta{environment name}. The profiler entry will be called \declareandlabel{\pgfprofileenv}\meta{environment name} where |\pgfprofileenv| is predefined as |<ENV>|.
