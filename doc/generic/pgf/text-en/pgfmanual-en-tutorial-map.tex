...
The |level distance| tells \tikzname\ the distance between different
levels or layers of a tree. The |sibling distance| is, as the name
suggests, the distance between siblings of the tree.
...
specifying options for children ``at the right place'' is somewhat
complicated and you should peruse Section~\ref{section-tree-options} on
...
simply by changing this key for a single child of a whole level. By
...
seems a bit mysterious at first sight: Why does not \TeX\ hyphenate
...
each of the four main branches, and these styles to (a) setup the
...
placed, the fifth is the like of items to be shown, and the sixth is a
