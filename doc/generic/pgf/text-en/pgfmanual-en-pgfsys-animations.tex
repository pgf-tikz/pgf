...
\begin{sysanimateattribute}{stage}
  ...
  Specify values with |\pgfsysanimvaltext|. As for
  |visibility|, only two values are allowed: 
  |visible| and |hidden|.
\begin{codeexample}[animation list={-1,0,1,2,3},animation bb={(1.2,-0.8)rectangle(2.8,0.8)}]
\animationexample{my node}{}{
  \pgfsysanimkeytime{0}{1}{1}{0}{0}
  \pgfsysanimvaltext{visible}
  \pgfsysanimkeytime{2}{1}{1}{0}{0}
  \pgfsysanimvaltext{visible}
  \pgfsysanimate{stage}
