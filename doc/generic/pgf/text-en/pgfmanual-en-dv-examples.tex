...
\begin{tikzpicture}[baseline]
  \datavisualization [
    ...
    clean ticks,
    x axis={
      major ticks at={-1/$-1$,1,0.5*pi/{$\pi/2$},2,pi/$\pi$},
      grid={
        common={max extend=\pgfdvmax+0.1,min extend=\pgfdvmin-0.1},
        major={at={-1,...,3.1416}},
        minor={at={-1,-0.9,...,3.1416}},
      },
      label=$x$
    },
    y axis={
      major ticks at={-1/\pgfmathprintnumber{-1},0,1},
      major grid at={-1,...,1},
      minor grid at={-1,-0.9,...,1},
      label=$y$,
    }
  ]
