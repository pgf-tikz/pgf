...
\tikzname\ expects a path operation. Node specifications can also be given 
\emph{inside} certain path oeprations; this is explained later.
...
\end{codeexample}
  ...
  computer graphics and Beziér curves if you are intrigued.
\begin{codeexample}[]
