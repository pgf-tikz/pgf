...
Users familiar with \textsc{metafont} will find that the
commands and the syntax of \tikzname\ often resembles
\textsc{metafont}. The commands and syntax of \textsc{pstricks} has
also influenced \tikzname's syntax. However, in some cases I decided to
use a new syntax that, I hope, is more appropriate than the syntax of
either \textsc{metafont} or \textsc{pstricks}. 
