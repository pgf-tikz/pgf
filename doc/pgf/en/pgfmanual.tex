...
%\includeonly{pgfmanual-tutorial}
...
\index{File|see{Package and files}}
...
\begin{tikzpicture}[scale=2]
  \shade[top color=blue,bottom color=gray!50] (0,0) parabola right (1.5,2.25) |- (0,0);
