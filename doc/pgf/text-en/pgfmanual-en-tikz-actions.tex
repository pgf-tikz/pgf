...
\begin{itemize}
  ...
  Note that these options do not work if you use PostScript as your
  output format. The reason is that PostScript does not support
  transparency. However, transparency works nicely for \textsc{pdf}
  and \textsc{svg}.
...
\begin{itemize}
  ...
  Note, again, that this option does not work if you use PostScript as
  your output format.
