...
%\includeonly{pgfmanual-en-libraries}
...
\tikzstyle{every node}=[fill,draw=black]

\tikz [grow cyclic,shape=circle,rotate=90,very thick,level distance=13mm,white]
  \node {} children[color=\A] \A in {red,green,blue}
   { node {} children[color=\A!50!\B] \B in {red,green,blue}
     { node {} children[color=\A!50!\B!50!\C] \C in {black,gray,white}
       { node {} }
     }
   };
\end{codeexample}
