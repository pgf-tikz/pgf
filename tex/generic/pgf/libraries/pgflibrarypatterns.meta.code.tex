...
\pgfdeclarepattern{
  ...
  bottom left={\pgfpoint{0}{-.5*(\pgfkeysvalueof{/pgf/pattern keys/line width})}},
  top right={\pgfpoint{\pgfkeysvalueof{/pgf/pattern keys/distance}}{.5*(\pgfkeysvalueof{/pgf/pattern keys/line width})}},
  tile size={\pgfpoint{\pgfkeysvalueof{/pgf/pattern keys/distance}}{\pgfkeysvalueof{/pgf/pattern keys/distance}}},
  tile transformation={\pgftransformrotate{\pgfkeysvalueof{/pgf/pattern keys/angle}}},
  defaults={
  ...
  code={%
    ...
    \pgfpathlineto{\pgfpoint{\pgfkeysvalueof{/pgf/pattern keys/distance}}{0}}%
    \pgfusepath{stroke}
  },
}
...
\pgfdeclarepattern{
  ...
  top right={\pgfpoint{\pgfkeysvalueof{/pgf/pattern keys/distance}}{\pgfkeysvalueof{/pgf/pattern keys/distance}}},
  tile size={\pgfpoint{\pgfkeysvalueof{/pgf/pattern keys/distance}}{\pgfkeysvalueof{/pgf/pattern keys/distance}}},
  tile transformation={\pgftransformrotate{\pgfkeysvalueof{/pgf/pattern keys/angle}}},
  defaults={
    distance/.initial=3pt,
  ...
  code={%
    \pgfsetlinewidth{\pgfkeysvalueof{/pgf/pattern keys/line width}}%
    \pgfpathmoveto{\pgfpoint{0}{.5*(\pgfkeysvalueof{/pgf/pattern keys/distance})}}
    \pgfpathlineto{\pgfpoint{\pgfkeysvalueof{/pgf/pattern keys/distance}}{.5*(\pgfkeysvalueof{/pgf/pattern keys/distance})}}
    \pgfpathmoveto{\pgfpoint{.5*(\pgfkeysvalueof{/pgf/pattern keys/distance})}{0}}
    \pgfpathlineto{\pgfpoint{.5*(\pgfkeysvalueof{/pgf/pattern keys/distance})}{\pgfkeysvalueof{/pgf/pattern keys/distance}}}
    \pgfusepath{stroke}
  },
}
...
\pgfdeclarepattern{
  ...
  code={%
    \pgfpathcircle%
      {\pgfpoint{.5*(\pgfkeysvalueof{/pgf/pattern keys/distance})}{.5*(\pgfkeysvalueof{/pgf/pattern keys/distance})}}%
      {\pgfkeysvalueof{/pgf/pattern keys/radius}}
    \pgfusepath{fill}
  },
}
