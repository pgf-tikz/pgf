...
\protected\long\def\pgfparserxdef@e#1#2#3#4#5%>>>
  {%
    ...
    % is valid
    \pgfparserxdef@arg@count
      =\the\numexpr0\pgfparserxdef@argcount#4\pgfparserx@mark\relax\relax
...
\protected\def\pgfparserxswitch#1%>>>
  {%
...
\protected\def\pgfparserx@getnexttoken@b%>>>
  {%
    \pgfparserx@ifcsundefTF{\pgfparserx@type{\pgfparserxstate}}
      {%
        \pgfparserx@ifcsundefTF{\pgfparserx@type{all}}
          {%
            ...
            \pgfparserx@ifcsundefTF{\pgfparserx@undefined{\pgfparserxstate}}
              {%
...
% <<<
\protected\long\def\pgfparserxreinsert#1%>>>
  {%
