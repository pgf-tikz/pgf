...
\def\pgf@matrix@endcell{%
    ...
    \fi%
    \pgfsys@endpicture%
    \pgf@matrix@process@nextcell@options%
      {\pgf@matrix@last@nextcell@options}%
    \pgf@matrix@endcell@cont}

\def\pgf@matrix@process@nextcell@options#1{%
    ...
    {%
      ...
      \ifpgf@matrix@fixed%
        % \pgf@matrix@maxxN is garbage if this is the first cell
        % in the column:
        \ifnum\pgfmatrixcurrentcolumn>\pgf@matrix@numberofcolumns%
          \global\expandafter\def%
            \csname%
              pgf@matrix@maxx\the\pgfmatrixcurrentcolumn%
            \endcsname%
            {0pt}%
        \fi
        %
