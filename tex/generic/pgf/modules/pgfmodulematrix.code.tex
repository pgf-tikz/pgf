...
% \begin{tikzpicture}
%
%   \draw (0,0) circle [radius=1mm];  % b.north will lie on the center of this circle
%
%   \pgfmatrix{rectangle}{text}{mymatrix}{\pgfusepath{}}{\pgfpointanchor{b}{north}}{\let\&=\pgfmatrixnextcell}
%   {
%     \draw (0,0) circle [radius=1cm]; \& \node (a) [draw] {Hallo}; \\
%     \node (b) [draw] {Welt};  \& \draw (0,0) circle [radius=5mm]; \\
%   }
%
%   \draw [->] (a) -- (b);
%
...
% {
%   \draw (0,0) circle [radius=1cm]; \pgfmatrixnextcell[1cm] \node (a) [draw] {Hallo}; \\
%   \node (b) [draw] {Welt};  \pgfmatrixnextcell \draw (0,0) circle [radius=5mm]; \\
% }
