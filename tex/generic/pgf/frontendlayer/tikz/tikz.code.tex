...
\def\tikzaddtikzonlycommandshortcutlet#1#2{%
    \expandafter\def\expandafter\tikz@installcommands\expandafter{\tikz@installcommands
        \expandafter\let\csname tikz@orig\detokenize{#1}\expandafter\endcsname=#1%
        \let#1=#2%
    }%
    \expandafter\def\expandafter\tikz@uninstallcommands\expandafter{\tikz@uninstallcommands
        \expandafter\let\expandafter#1\csname tikz@orig\detokenize{#1}\endcsname
    }%
}%
...
\def\tikzaddtikzonlycommandshortcutdef#1#2{%
    \expandafter\def\expandafter\tikz@installcommands\expandafter{\tikz@installcommands
        \expandafter\let\csname tikz@orig\detokenize{#1}\endcsname=#1%
        \def#1{#2}%
    }%
    \expandafter\def\expandafter\tikz@uninstallcommands\expandafter{\tikz@uninstallcommands
        \expandafter\let\expandafter#1\csname tikz@orig\detokenize{#1}\endcsname
