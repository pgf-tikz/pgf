...
\def\tikz@startup@env{%
  \expandafter\let\expandafter\tikz@origsemi\tikz@activesemicolon
  \expandafter\let\expandafter\tikz@origcolon\tikz@activecolon
  \expandafter\let\expandafter\tikz@origbar\tikz@activebar
  \tikz@deactivatthings%
...
% Example:
%
% \draw (0,0) \foreach \x in {1,2,3} {-- (\x,0) circle [radius=1cm]} -- (5,5);
...
{%
  ...
  \shade (0pt,0pt) circle [radius=\pgfplotmarksize];%
}%
        ...
        \pgfsys@begin@text%
          ...
          \bgroup%
            ...
            \iftikz@handle@active@code%
              ...
              \let\tikz@orig@shorthands\pgfutil@empty%
            \fi%
            \expandafter\let\tikz@activesemicolon\tikz@origsemi
            \expandafter\let\tikz@activecolon\tikz@origcolon
            \expandafter\let\tikz@activebar\tikz@origbar
...
% Reserved keys for future tagging support. No-ops for now.
\tikzset{actualtext/.code={},alt/.code={},artifact/.code={}}
