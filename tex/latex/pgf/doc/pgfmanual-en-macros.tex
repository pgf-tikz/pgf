...
\def\endofcodeexample#1{%
  ...
  \ifpgfmanual@setup@code%
    \gdef\pgfmanual@do@this{%
      ...
      \catcode`\^^M=10
      \ignorespaces\expandafter\scantokens\expandafter{\code@temp\ifhmode\unskip\fi}%
      ...
      \setbox\codeexamplebox=\hbox{%
        ...
        {%
          ...
          \colorbox{graphicbackground}{\color{black}\ignorespaces%
            \code@pre\ignorespaces\expandafter\scantokens\expandafter{\code@temp\ifhmode\unskip\fi\ignorespaces}\code@post\ignorespaces}%
        }%
        \else%
        ...
        \foreach \pgfmanualtime/\pgfmanualtimehow in\code@animation@list{%
          \setbox\codeexampleboxanim=\hbox{\colorbox{animationgraphicbackground}{%
              ...
              \scalebox{\pgfmanualanimscale}{\color{black}\ignorespaces%
                \code@animation@pre\ignorespaces\expandafter\scantokens\expandafter{\code@temp\ifhmode\unskip\fi\ignorespaces}\code@animation@post\ignorespaces}%
            }}%
