...

{
	...
	{
		\def\mathparserTestCases{%
			\pgfmathfloattest{sin(90)}{1.0}%
			\pgfmathfloattest{cos(90)}{0.0}%
			\pgfmathfloattest{tan(45)}{1.0}%
			\pgfmathfloattest{sec(45)}{1.41429}%
			\pgfmathfloattest{cosec(30)}{2.0}%
			\pgfmathfloattest{cot(15)}{3.73215}%
			\pgfmathfloattest{asin(0.7071)}{44.99945}%
			\pgfmathfloattest{acos(0.5)}{60}%
			\pgfmathfloattest{atan(1)}{45}%
			\pgfmathfloattest{atan(16001)}{90}%
			\pgfmathfloattest{atan(-16001)}{-90}%
			%\pgfmathfloattest{atan2(-4,3)}{-53.13011}%
		}%
	...
	
	{
		...
		\def\mathparserTestCases{%
			\pgfmathfloattest{sin(pi/2)}{1.0}%
			\pgfmathfloattest{cos(pi/2)}{0.0}%
			\pgfmathfloattest{tan(pi/4)}{1.0}%
			\pgfmathfloattest{sec(pi/4)}{1.41429}%
			\pgfmathfloattest{cosec(rad(30))}{2.0}%
			\pgfmathfloattest{cot(rad(15))}{3.73215}%
			\pgfmathfloattest{asin(0.7071)}{0.785388564086562}% 44.99945}%
			\pgfmathfloattest{acos(0.5)}{1.0471975511966}%
			\pgfmathfloattest{atan(1)}{0.785398163397448}%45}%
			\pgfmathfloattest{atan(16001)}{1.570796326794}%
			\pgfmathfloattest{atan(-16001)}{-1.570796326794}%
			%\pgfmathfloattest{atan2(-4,3)}{-53.13011}%
		}%
