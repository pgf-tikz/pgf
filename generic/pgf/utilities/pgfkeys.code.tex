...
\def\pgfkeys@unpack#1=#2=#3\pgfkeys@stop{%
  ...
  \else%
    ...
    \ifx\pgfkeyscurrentvalue\pgfkeysvaluerequired%
      \pgfkeysinsertvalue{/errors/value required/.@cmd}\pgfkeyscurrentkey\pgfkeyscurrentvalue\pgfeov%
    \else%
      \pgfkeys@case@one%
    \fi%
  \fi}
...
{%
  ...
  \else%
    \pgfkeysinsertvalue{/errors/value forbidden/.@cmd}\pgfkeyscurrentkey\pgfkeyscurrentvalue\pgfeov%
  \fi%
}{}}}
...
\def\pgfkeys@handle@boolean#1#2{%
  ...
  \else%
    \pgfkeysinsertvalue{/errors/boolean expected/.@cmd}\pgfkeyscurrentkey{#2}\pgfeov%
  \fi
}
