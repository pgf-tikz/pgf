...
\def\pgfsysanimvalcolorcmyk#1#2#3#4{%
  ...
  \ifpgfsysanim@is@snap%
    \pgferror{color cmyk not yet implemented}% must call
...
\def\pgfsysanimvalcolorcmy#1#2#3{%
  ...
  \ifpgfsysanim@is@snap%
    \pgferror{color cmy not yet implemented}% must call
                                % \pgfsysanim@snap@record{{coverted rgb values}}
  \fi%  
}
...
\def\pgfsysanim@comp@dash{\pgferror{dash animation not yet implemented}}
\def\pgfsysanim@comp@color{\pgferror{color animation not yet implemented}}
\def\pgfsysanim@comp@viewbox{\pgferror{view animation not yet implemented}}
