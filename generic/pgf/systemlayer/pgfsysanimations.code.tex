...
\def\pgfsysanimsnapshot#1{%
  ...
  \pgfsysanim@is@snap@or@basetrue%
}
...
\newif\ifpgfsysanim@is@snap@or@base
...
\def\pgfsysanimate#1{%
  \ifx\pgfsysanim@base@value\relax%
  \else%
    \pgfsysanim@install@base{#1}%
  \fi%
...
\def\pgfsysanim@install@base#1{%
  {%
    ...
    \else%
      ...
      \let\pgfsysanim@first@time\pgfsysanim@prev@time%
      ...
      \pgfsysanim@valid@snapshot@timetrue%
      % Second, compute code:
      \let\pgfsysanim@code@begin\relax%
      \let\pgfsysanim@code@end\pgfutil@empty%
      \csname pgfsysanim@prep@attr@#1\endcsname%
      ...
      \else%
        % Attach to object:
        \expandafter\expandafter\expandafter\pgfsysanim@call@attacher%
        \expandafter\expandafter\expandafter{\expandafter\expandafter\expandafter}\expandafter\expandafter\expandafter{\expandafter\pgfsysanim@code@end\expandafter}\expandafter{\pgfsysanim@code@begin}%
      \fi%
    \fi%
  }%
}
...
\def\pgfsysanimkeytime#1#2#3#4#5{%
  ...
  \pgfsysanim@base@nextfalse%
  \ifpgfsysanim@is@snap%
    \pgfsysanim@is@snap@or@basetrue%
  \else%
    \pgfsysanim@is@snap@or@basefalse%
  \fi%
}
...
\def\pgfsysanimkeybase{%
  \pgfsysanim@base@nexttrue%
  \pgfsysanim@is@snap@or@basetrue%
}
\newif\ifpgfsysanim@base@next
...
\def\pgfsysanimvalcurrent{%
  \ifpgfsysanim@base@next%
  \else%
    \pgfsys@animation@val@current%
  \fi%
  \ifpgfsysanim@is@snap@or@base%
...
\let\pgfsysanim@base@value\relax%
...
\def\Pgfsysanim@seTTer#1#2{%
  ...
  \ifdim\pgfsysanim@repeat@frac pt=0pt% goto one before:
    \pgfmathsetmacro\pgfsysanim@repeat@decimal{\pgfsysanim@repeat@decimal-1}%
...
\def\pgfsysanim@prep@attr@linewidth{%
  \ifpgfsysanim@valid@snapshot@time%
    ...
    \pgfsysanim@cap@scalar{\pgfsysanim@x@val}{0}{16383}%
...
\def\pgfsysanim@prep@attr@viewbox{%
  \ifpgfsysanim@valid@snapshot@time%
    ...
    \pgfsys@clean@type\pgfsysanim@type@temp\pgfsysanim@whom@type%
    \expandafter\xdef\csname pgfsysanim@hook@for@\pgfsys@id@ref{\pgfsysanim@whom@id}{\pgfsysanim@type@temp}\endcsname%
...
\def\pgfsysanim@prep@attr@path{%
  \ifpgfsysanim@valid@snapshot@time%
    ...
    \pgfsys@clean@type\pgfsysanim@type@temp\pgfsysanim@whom@type%
    \expandafter\def\expandafter\pgfsysanim@temp\expandafter{\csname pgfsysanim@phook@for@\pgfsys@id@ref{\pgfsysanim@whom@id}{\pgfsysanim@type@temp}\endcsname}
