...
\def\pgfsysanim@do@snap#1{%
  {%
    ...
    \else%
      ...
      \else%
        % Attach to object:
        \expandafter\pgfsysanim@call@attacher\expandafter{\pgfsysanim@code@begin}{}{}%
      \fi%
    \fi%
  }%
}
...
\def\pgfsysanim@prep@attr@visibility{%
  \ifpgfsysanim@valid@snapshot@time%
    ...
    \ifx\pgfsysanim@text@val\pgf@hidden@text%
      \let\pgfsysanim@code@begin\pgfsysanim@hider%
    \fi%
  \fi%
}
\def\pgf@hidden@text{hidden}
\def\pgfsysanim@hider{{\pgfsys@discardpath\pgfsys@clipnext\pgfsys@moveto{0pt}{0pt}\pgfsys@discardpath}}
