...
\def\pgfsysanimkeypaced{%
  \pgfsys@animation@paced%
  % Snapshot
  \pgfsysanim@pacedtrue%
  \ifpgfsysanim@is@snap%
    \pgferror{paced mode not implemented for snapshots}%
  \fi%
}
...
\def\pgfsysanimkeyspline{%
  \pgfsys@animation@spline%
  % Snapshot
  \pgfsysanim@pacedfalse%
}
...
\def\pgfsysanimvalcolorcmyk#1#2#3#4{%
  ...
  \ifpgfsysanim@is@snap%
    ...
    \expandafter}%
    \expandafter\pgfsysanim@snap@record\expandafter{\pgfsys@temp}%
  \fi%  
}
...
\def\pgfsysanim@snap@record#1{% records a new entry for the timeline
  ...
  \expandafter\edef\csname pgfsysanim@snap@\the\pgfsysanim@snap@count\endcsname{\pgfsysanim@time{#1}}%
}
...
\def\pgfsysanim@prep@attr@visibility{%
  \ifpgfsysanim@valid@snapshot@time%
    ...
    \ifx\pgfsysanim@text@val\pgf@hidden@text%
      \let\pgfsysanim@code@begin\pgfsysanim@hider@begin%
      \let\pgfsysanim@code@end\pgfsysanim@hider@end%
    \fi%
  \fi%
}
\def\pgf@hidden@text{hidden}
\def\pgfsysanim@hider@begin{\pgfsys@beginscope{\pgfsys@discardpath\pgfsys@clipnext\pgfsys@moveto{0pt}{0pt}\pgfsys@discardpath}}
\def\pgfsysanim@hider@end{\pgfsys@endscope}
...
\def\pgfsysanim@add@trans{%
  ...
  \else%
    ...
    \fi%
    \expandafter\expandafter\expandafter\pgfsysanim@add@trans@\expandafter\expandafter\expandafter{\expandafter\pgfsysanim@snap@canvas@transform@pre\expandafter}\expandafter{\pgfsysanim@snap@canvas@transform@post}%
  \fi%
}  
\def\pgfsysanim@add@trans@#1#2{%
...
\def\pgfsysanim@prep@attr@viewbox{%
  \ifpgfsysanim@valid@snapshot@time%
    ...
    \expandafter\xdef\csname pgfsysanim@hook@for@\pgfsys@id@ref{\pgfsysanim@whom@id}{\pgfsysanim@whom@type}\endcsname{{\pgfsysanim@x@val}{\pgfsysanim@y@val}{\pgfsysanim@z@val}{\pgfsysanim@w@val}}%
  \fi%
}
...
\def\pgfsysanim@comp@path{\pgferror{path animation not yet implemented}}
