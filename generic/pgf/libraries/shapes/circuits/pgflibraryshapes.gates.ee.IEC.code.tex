...
\pgfdeclareshape{direction IEC}
{
  \savedanchor\northeast{
    % Right border is given by right extend
    \pgf@x=0pt%
    \csname pgf@arrow@right@\pgfkeysvalueof{/pgf/direction IEC arrow}\endcsname
  ...
  \savedanchor\southwest{
    ...
    \pgf@x=0pt%
    \csname pgf@arrow@left@\pgfkeysvalueof{/pgf/direction IEC arrow}\endcsname
    \pgf@x=-\pgf@x%
    % Height is given by minimum height/2
    \pgfmathsetlength{\pgf@y}{\pgfkeysvalueof{/pgf/minimum height}}%
    \pgf@y=-.5\pgf@y
  ...
  \beforebackgroundpath{
    {
      \pgfsetarrowsend{\pgfkeysvalueof{/pgf/direction IEC arrow}}
      \pgfsys@beginscope
      \pgflowlevelsynccm%
...
\pgfkeys{
  /pgf/direction IEC arrow/.initial=direction IEC,
  /pgf/direction IEC size/.initial=4pt,
}


% Special arrow for IEC directions:

\pgfarrowsdeclare{direction IEC}{direction IEC}
{
  \pgfmathsetlength\pgfutil@tempdima{\pgfkeysvalueof{/pgf/direction IEC size}}%
...
\pgfdeclareshape{var make contact IEC}
{
  ...
  \savedanchor\southwest{%
    ...
    \pgfmathsetlength\pgf@ya{\pgfkeysvalueof{/pgf/outer ysep}}%
    \pgf@y=-\pgf@ya%
    \pgfmathsetlength{\pgfutil@tempdima}{\pgfkeysvalueof{/pgf/var make contact IEC circle radius}}
  ...
  \backgroundpath{
    ...
    \pgfpathmoveto{\pgfpointadd{\pgfqpoint{\pgf@xa}{0pt}}{%
        \pgfpointscale{\pgfkeysvalueof{/pgf/var make contact IEC circle radius}}{\pgfqpoint{\pgf@xc}{\pgf@yc}}}}
    \pgfpathlineto{\pgfqpoint{\pgf@xb}{\pgf@yb}}
  }
}

\pgfkeys{
  /pgf/var make contact IEC circle radius/.initial=1pt
}
