...
\def\pgfluamathatan@#1{%
  \pgfluamathgetresult{math.deg(math.atan(#1))}}
\def\pgfluamathatantwo@#1#2{%
  \pgfluamathgetresult{math.deg(math.atan2(#1,#2))}}
\def\pgfluamathasin@#1{%
  \pgfluamathgetresult{math.deg(math.asin(#1))}}
\def\pgfluamathacos@#1{%
  \pgfluamathgetresult{math.deg(math.acos(#1))}}
\def\pgfluamathcot@#1{%
  \pgfluamathgetresult{1/math.tan(math.rad(#1))}}
\def\pgfluamathsec@#1{%
  \pgfluamathgetresult{1/math.cos(math.rad(#1))}}
\def\pgfluamathcosec@#1{%
  \pgfluamathgetresult{1/math.sin(math.rad(#1))}}
\def\pgfluamathexp@#1{%
  \pgfluamathgetresult{math.exp(#1)}}
\def\pgfluamathln@#1{%
  \pgfluamathgetresult{math.log(#1)}}
\def\pgfluamathlogten@#1{%
  \pgfluamathgetresult{math.log10(#1)}}
\def\pgfluamathsqrt@#1{%
  \pgfluamathgetresult{math.sqrt(#1)}}
\def\pgfluamathrnd@{%
  \pgfluamathgetresult{math.random()}}
\def\pgfluamathrand@{%
  \pgfluamathgetresult{math.random(-1,1)}}
