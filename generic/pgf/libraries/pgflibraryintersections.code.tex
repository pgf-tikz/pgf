...
\def\pgf@intersect@generate@solution@transformed#1{%
  \pgfextract@process\pgfpoint@intersect@temp{#1}%
  \def\pgf@marshal{\expandafter\def\csname pgfpoint@intersect@solution@\the\pgfintersectionsolutions\endcsname}%
  \expandfter\pgf@marshal\expandafter{%
  	\expandafter\begingroup
	  	\expandfter\pgftransforminvert%
	  	\pgfpoint@intersect@temp\relax%
	  	\pgfpos@transform{\pgf@x}{\pgf@y}%
	  	\global\pgf@x=\pgf@x%
	  	\global\pgf@y=\pgf@y%
		\endgroup%
	}%
...
\let\pgf@intersect@generate@solution=\pgf@intersect@generate@solution@transformed
