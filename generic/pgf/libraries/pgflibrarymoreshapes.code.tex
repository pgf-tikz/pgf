...
\pgfdeclareshape{polygon}{%
	...
	\anchor{mid}{\centerpoint\pgfmathsetlength\pgf@y{.5ex}}%
 	\anchor{base}{\centerpoint\pgf@y=0pt}%
 	\anchor{north}{\pgf@anchor@polygon@border{\pgfpoint{+0pt}{+\radius}}}%
 	\anchor{south}{\pgf@anchor@polygon@border{\pgfpoint{+0pt}{+-\radius}}}%
 	\anchor{east}{\pgf@anchor@polygon@border{\pgfpoint{+\radius}{+0pt}}}%
 	\anchor{west}{\pgf@anchor@polygon@border{\pgfpoint{+-\radius}{+0pt}}}%
 	\anchor{north east}{\pgf@anchor@polygon@border{\pgfpoint{+\radius}{+\radius}}}%
 	\anchor{north west}{\pgf@anchor@polygon@border{\pgfpoint{+-\radius}{+\radius}}}%
 	\anchor{south east}{\pgf@anchor@polygon@border{\pgfpoint{+\radius}{+-\radius}}}%
 	\anchor{south west}{\pgf@anchor@polygon@border{\pgfpoint{+-\radius}{+-\radius}}}%
	...
	\backgroundpath{%
		...
		\pgfmathloop%
			...
			% Create anchors. Manually \xdef as \gdef is normally used by \anchor.
			%
			\expandafter\xdef\csname pgf@anchor@polygon@corner\space\pgfmathcounter\endcsname{%
				\noexpand\pgf@lib@shapescorneranchor{\pgfmathcounter}%
			}%
			\expandafter\xdef\csname pgf@anchor@polygon@side\space\pgfmathcounter\endcsname{%
