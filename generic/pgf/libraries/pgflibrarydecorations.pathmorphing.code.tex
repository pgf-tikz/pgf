...
\pgfdeclaredecoration{random steps}{step}
{
  ...
  {
    \ifdim\pgfdecorationsegmentlength<\pgfdecoratedsubpathremainingdistance\relax%
      \pgf@xc=\pgfdecorationsegmentlength%
    \else%
      \pgf@xc=\pgfdecoratedsubpathremainingdistance%
    \fi%
    \pgfpathlineto{
      \pgfpointadd
      {\pgfpoint{\pgf@xc}{0pt}}
