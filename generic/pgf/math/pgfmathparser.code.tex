...
\def\pgfmath@parsescientific@{%
	\typeout{\the\c@pgfmath@parsecounta}%
...
\def\pgfmath@scientific@@@#1#2#3#4#5#6\pgfmath@{%
		...
		\fi%
		\ifcase\c@pgfmath@counta
			\edef\pgfmath@sci@factor{1}\relax%
		\or%
			\edef\pgfmath@sci@factor{10}\relax%
		\or%
			\edef\pgfmath@sci@factor{100}\relax%
		\or%
			\edef\pgfmath@sci@factor{1000}\relax%
		\or%
			\edef\pgfmath@sci@factor{10000}\relax%
		\else%
			\edef\edef\pgfmath@sci@factor{}\relax%
		\fi%
