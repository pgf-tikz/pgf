...
\def\pgfmath@parseunits@#1#2{%
	...
	\else%
		...
		\ifpgfmath@in@%
			...
			\else%
				\edef\pgfmath@tokens{#1#2}%
				\let\pgfmath@parsenext\pgfmath@parsescientfic%
			\fi%
		\else
...
\def\pgfmath@parsescientfic#1#2#3#4{%	
	\typeout{parsing scientific: #1#2#3#4}%
	\c@pgfmath@parsecounta#3#4\relax%
	\ifcase\c@pgfmath@parsecounta
		\c@pgfmath@parsecountb1\relax%
	\or%
		\c@pgfmath@parsecountb10\relax%
	\or%
		\c@pgfmath@parsecountb100\relax%
	\or%
		\c@pgfmath@parsecountb1000\relax%
	\or%
		\c@pgfmath@parsecountb10000\relax%
	\else%
		\c@pgfmath@parsecountb0\relax%
	\fi%
	\pgfmath@parsex\pgfmath@resulttemp pt\relax%
	\ifx#2-%
		\divide\pgfmath@parsex\c@pgfmath@parsecountb\relax%
	\else%
		\multiply\pgfmath@parsex\c@pgfmath@parsecountb\relax%
	\fi%
	\edef\pgfmath@resulttemp{\pgfmath@tonumber{\pgfmath@parsex}}%
	\pgfmath@parseunits@}
