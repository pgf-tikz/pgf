...
\def\pgfmathprintnumber@fixed@styleDEFAULT@impl@period#1.#2\pgfmathfloat@EOI{%
	...
	\else
		\pgfmathprintnumber@fixed@styleDEFAULT@impl@noperiod#1\pgfmathfloat@EOI\pgfmathfloat@EOI\pgfmathfloat@EOI
	\fi
	\pgfmathprintnumber@fixed@styleDEFAULT@DEC@SEP #2%
}%
...
\def\pgfmathprintnumber@fixed@styleDEFAULT@impl@noperiod@printall#1\pgfmathfloat@EOI\pgfmathfloat@EOI\pgfmathfloat@EOI{#1}%
...
\def\pgfmathfloatrounddisplaystyle@shared@impl#1#2e#3\relax#4#5#6{%
	...
	\or\pgfmathprintnumber@fixed@style{#2}#1#2e0\relax%
		#4%
		#6%
	\or-\pgfmathprintnumber@fixed@style{#2}#1#2e0\relax#4#6%
	\or NaN
	\or\infty%
	\or-\infty%
	\fi
...
\def\pgfmathfloatrounddisplaystyle@std#1#2e#3\relax{%
	\pgfutilensuremath{\pgfmathfloatrounddisplaystyle@shared@impl#1#2e#3\relax{\cdot}{}{10^{#3}}}%
}
\def\pgfmathfloatrounddisplaystyle@subscript#1#2e#3\relax{%
	\pgfutilensuremath{\pgfmathfloatrounddisplaystyle@shared@impl#1#2e#3\relax{}{1}{_{#3}}}%
}
\def\pgfmathfloatrounddisplaystyle@e#1#2e#3\relax{%
	\pgfmathfloatrounddisplaystyle@shared@impl#1#2e#3\relax{}{1}{%
		e\ifnum#3<0\relax
			{\count0=#3\relax
...
\pgfkeys{%
	...
	set decimal separator/.store in=	\pgfmathprintnumber@fixed@styleDEFAULT@DEC@SEP,
	set thousands separator/.store in=	\pgfmathprintnumber@fixed@styleDEFAULT@THOUSAND@SEP,
	use period/.style=		{/pgf/number format/set decimal separator={.},/pgf/number format/set thousands separator={\relax{,}}},
	use comma/.style=		{/pgf/number format/set decimal separator={\relax{,}},/pgf/number format/set thousands separator={.}},
...
\def\pgfmathprintnumber@INT@DETECT@issci#1#2e#3\relax{%
	...
	\ifnum#1<3\relax
		...
		\ifpgfmathfloatroundhasperiod
			\pgfmathprintnumber@SCI@issci#1#2e#3\relax
		\else
			\pgfmathprintnumber@fixed@style{\pgfmathresult}#1#2e#3\relax
		\fi
	\else
		\pgfmathfloatrounddisplaystyle#1#2e#3\relax%
	\fi
