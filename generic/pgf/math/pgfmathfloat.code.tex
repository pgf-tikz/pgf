	...
	\begingroup
		...
		\if1\pgfmathfloat@loc@TMPa
			...
			\else
				...
				\pgfmathfloatcreate{1}{1.0}{\pgfkeysvalueof{/pgf/number format/frac precision}}%
				...
				\afterassignment\pgfmathfloat@gobble@until@relax
				\pgfmathfloat@b@S=\pgfmathresult pt\relax
			...
			%
			%
			\def\pgfmathfloat@loc@@to@int##1.##2\relax{%
				\pgfmathresultcounter=##1
				\ifdim0.##2pt>0.5pt
					\advance\pgfmathresultcounter by1
				\fi
			}%
			\expandafter\pgfmathfloat@loc@@to@int\pgfmathfloat@scaled@counter\relax
			%
