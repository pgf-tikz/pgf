...
\def\pgfmathadd@#1#2{%
	\begingroup%
		\edef\pgfmath@one{#1}%
		\edef\pgfmath@two{#2}%
		\pgfmath@x\pgfmath@one pt\relax%
		\pgfmath@y\pgfmath@two pt\relax%
...
\def\pgfmathmultiply@#1#2{%
	\begingroup%
		...
		\edef\pgfmath@two{#2}%
		\pgfmath@x\pgfmath@one pt\relax%
		\pgfmath@x\pgfmath@two\pgfmath@x%
		\pgfmath@returnone\pgfmath@x%
	\endgroup%
}
...
\def\pgfmathdivide@#1#2{%
	\begingroup%
		...
		\edef\pgfmath@two{#2}%
		\pgfmath@x\pgfmath@one pt\relax%
		\pgfmath@xa\pgfmath@two pt\relax%
...
\def\pgfmathmod#1#2{%
	...
	\pgfmathmod@{\pgfmath@moda}{\pgfmath@modb}%
}
\def\pgfmathmod@#1#2{%
	\begingroup%
		\edef\pgfmath@one{#1}%
		...
		\pgfmath@xb\pgfmath@two pt\relax%
...
\def\pgfmathpow@#1#2{%
	\begingroup%
		\edef\pgfmath@one{#1}%
		\edef\pgfmath@two{#2}%
		\pgfmath@xa\pgfmath@one pt\relax%
		\afterassignment\pgfmath@gobbletilpgfmath@%
		\expandafter\c@pgfmath@counta\pgfmath@two\relax\pgfmath@
