...
\pgfmathdeclarefunction{exp}{1}{%	
	\begingroup%
		...
		\pgfmathloop%
			...
			\divide\c@pgfmath@counta by65536\relax%
			\pgfmath@xc=1pt\relax%
			\divide\pgfmath@xc by\c@pgfmath@counta%
			\pgfmath@xa=\pgfmath@tonumber{\pgfmath@xc}\pgfmath@xa%
			\expandafter\pgfmath@xa\expandafter=\pgfmath@exp@arg\pgfmath@xa%
