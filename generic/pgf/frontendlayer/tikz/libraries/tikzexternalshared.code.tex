...
\def\tikzexternal@externalizefig@systemcall@reschedule#1{%
	\t@tikzexternal@tmpb={%
		...
		\tikzexternal@externalizefig@systemcall@assertsuccess% ... we need to add {\tikzexternal@curfilename} now:
	}%
	\xdef\pgfutil@tempa{\the\t@tikzexternal@tmpb{\tikzexternal@curfilename}}%
