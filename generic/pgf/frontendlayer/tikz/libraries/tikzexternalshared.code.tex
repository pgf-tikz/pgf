...
\def\tikzexternal@optimize@away@cmd#1{%
	\pgfutil@ifnextchar[{%
		\tikzexternal@optimize@away@cmd@{#1}%
	}{%
		\tikzexternal@optimize@away@cmd@{#1}[]%
	}%
}%
\def\tikzexternal@optimize@away@cmd@#1[#2]{%
	\pgfutil@ifnextchar\bgroup{%
		...
		\tikzexternal@optimize@away@cmd@@{#1}{#2}{<no argument in curly braces>}% give empty argument.
	}%
}%
