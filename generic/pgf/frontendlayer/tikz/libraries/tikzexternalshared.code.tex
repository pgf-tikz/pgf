...
\pgfqkeys{/tikz/external}{
	...
	mode/list and makefile/.code	= {\def\tikzexternal@opmode{5}\tikzexternal@genfigurelisttrue},
		...
		\iftikzexternal@genfigurelist
			...
			\else
				\pgfutil@ifundefined{tikzexternal@listmode@openedfile}{%
					...
					\if\tikzexternal@opmode5% mode='list and makefile'
						...
						\pgfutil@ifundefined{AtEndDocument}{}{%
							\AtEndDocument{\immediate\write16{===== mode=`list and makefile': Use 'make -f \tikzexternal@realjob.makefile' to generate all images. Then, re-run (pdf)latex \tikzexternal@realjob. =====}}%
						}%
					\fi
				}{}%
