...
\tikzset{
  circuit ee IEC/.style=
  {
    ...
    direction graphic       = direction IEC graphic,
    direction' graphic      = direction' IEC graphic,
...
\tikzset{
  direction IEC graphic/.style={
    shape=direction indicator IEC,
    circuit symbol filled,
    /pgf/direction indicator IEC arrow=triangle 45,
    transform shape
  },
  direction' IEC graphic/.style={
    direction IEC graphic,
    rotate=180
  }
}
