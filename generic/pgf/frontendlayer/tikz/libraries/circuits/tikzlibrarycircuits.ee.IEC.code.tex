...
\tikzset{
  circuit ee IEC/.style=
  {
    ...
    contact graphic               = contact IEC graphic,
    ...
    tunnel diode graphic          = tunnel diode IEC graphic,
    backward diode graphic        = backward diode IEC graphic,
    Schottky diode graphic        = Schottky diode IEC graphic,
    breakdown diode graphic       = breakdown diode IEC graphic,
    bulb graphic                  = bulb IEC graphic,
    voltage source graphic        = voltage source IEC graphic,
    current source graphic        = current source IEC graphic,
    make contact graphic          = make contact IEC graphic,
    break contact graphic         = break contact IEC graphic,
  }
}
