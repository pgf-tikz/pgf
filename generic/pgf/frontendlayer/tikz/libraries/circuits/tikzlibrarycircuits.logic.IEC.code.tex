...
\tikzset{
  circuit logic IEC/.style=
  {
    ...
    nand gate graphic   = nand gate IEC graphic,
    or gate graphic     = or gate IEC graphic,
    nor gate graphic    = nor gate IEC graphic,
    xor gate graphic    = xor gate IEC graphic,
    xnor gate graphic   = xnor gate IEC graphic,
    not gate graphic    = not gate IEC graphic,
    buffer gate graphic = buffer gate IEC graphic,
    %
