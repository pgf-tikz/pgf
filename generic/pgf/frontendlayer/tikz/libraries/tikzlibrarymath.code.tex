...
\long\def\tikz@math@@parse@bgroup{%
	\tikz@math@collecttosemicolon{\tikz@math@collected\relax\tikz@math@parse}}
...
\def\tikz@math@parse@keyword#1 {%
	\expandafter\ifx\csname tikz@math@process@keyword@#1\endcsname\relax%
	\else%
		\expandafter\let\expandafter\tikz@math@next\expandafter=\csname tikz@math@process@keyword@#1\endcsname%
	\fi%
	\tikz@math@next}
