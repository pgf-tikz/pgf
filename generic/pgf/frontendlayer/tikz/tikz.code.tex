...
\def\tikzstyle{%
  \pgfwarning{\string\tikzstyle\space is deprecated and will be
  removed in a future version of PGF! Please upgrade your code to use
  \string\tikzset.}%
  \pgfutil@ifnextchar\bgroup\tikz@style@parseA\tikz@style@parseB}%
