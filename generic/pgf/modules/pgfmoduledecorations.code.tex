...
\pgfkeys{
  ...
  /pgf/decoration/persistent precomputation/.store in=\pgf@decorate@persistent@pre,%
  /pgf/decoration/persistent postcomputation/.store in=\pgf@decorate@persistent@post,%
