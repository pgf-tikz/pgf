...
\def\tikzexternal@TEXDIALECT@collectpicture#1{%
	\def\tikzexternal@TEXDIALECT@collectpicture@arg{}%
...
\long\def\tikzexternal@laTeX@collect@until@end@tikzpicture#1#2\end#3{%
	...
	\ifx\tikzexternal@laTeX@collect@until@end@tikzpicture@\tikzexternal@laTeX@collect@until@end@tikzpicturetikzpicturestring
		\begingroup
		\t@tikzexternal@tmpa=\expandafter{\tikzexternal@TEXDIALECT@collectpicture@arg}%
		\t@tikzexternal@tmpb={#2}%
		\xdef\tikzexternal@laTeX@TMP{\the\t@tikzexternal@tmpa\the\t@tikzexternal@tmpb}%
		\endgroup
		\let\tikzexternal@TEXDIALECT@collectpicture@arg=\tikzexternal@laTeX@TMP
		\def\tikzexternal@TEXDIALECT@collectpicture@next{%
			\expandafter#1\expandafter{\tikzexternal@TEXDIALECT@collectpicture@arg}}%
	\else
		\begingroup
		\t@tikzexternal@tmpa=\expandafter{\tikzexternal@TEXDIALECT@collectpicture@arg}%
		\t@tikzexternal@tmpb={#2\end{#3}}%
		\xdef\tikzexternal@laTeX@TMP{\the\t@tikzexternal@tmpa\the\t@tikzexternal@tmpb}%
		\endgroup
		\let\tikzexternal@TEXDIALECT@collectpicture@arg=\tikzexternal@laTeX@TMP
		\def\tikzexternal@TEXDIALECT@collectpicture@next{%
