...
%
% 2. Insert '\declareandlabel' in the document where needed (see pgfmanual.pdflinks.code.tex )
...
%
% 3. @Christian: consider extensions of the parser such that it identifies path commands (partially)
%
%
